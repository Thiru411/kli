<div class="mapView">
    ...
    <div id="location_denied_message" style="display: none;">
        <p>Kindly allow location sharing when prompted, to locate your nearest branch.</p>
    </div>
   <div id="map_canvas" class="mapping"></div>
    <div class="midWrapper">
    <div class="location_details" id="result">
    </div>
    <div>
    <button class="button-click">Other Branches</button>
</div>
    </div>
</div>
