...
<div class="online-term-plan-bg">
    <div class="term-design">
            ...
            <div class="midWrapper">
                ...
                <div class="row">
                    <div class="coll-md-5">
                        ...
                        <p class="termDesc">Term insurance is one of the most important and simplest types of life insurance. It offers your family financial protection and safety in case of your unfortunate demise. It is the most crucial financial instrument that you must have.</p>
                        <p class="termDesc">You pay the insurer a specific amount of premium to ensure the financial cover (known as sum assured) that goes to your family (or nominee) if you pass away during the policy term.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="newamith">
            <div class="fullBg">
                    ...
                    <div class="authorDetails">
                        <div class="blogsTooltip">
                            <div class="authorName">
                                ...
                                <p><a href="https://in.linkedin.com/in/amit-raje-digitalexpert" class="linkedin" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></p>
                            </span>
                        </div>
                        ...
                        <div class="blogsTooltip">
                            <div class="authorName">
                                ...
                                <p><a href="https://in.linkedin.com/in/prasad-pimple-54ba489" class="linkedin" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></p>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="term-version">
                    ...
                    <p class="current-font">Last updated on <span><?=date("M d,Y",strtotime("yesterday"))?></span></p>
                </div>
            </div>
        </section>
        <section id="tableofContent">
            <div class="midWrapper"><span class="tocText">Table of Contents</span>
                <div class="contenttable show-more-height">
                    <div><a href="<?php echo $actual_link ?>#whatIsTermInsurance" class="tocContent"><span>What is Term Insurance?</span></a><a href="<?php echo $actual_link ?>#termInsuranceCalculator" class="tocContent"><span>Term Insurance Calculator</span></a><a href="<?php echo $actual_link ?>#onlinePlans" class="tocContent"><span>Online Insurance Plans from Kotak Life Insurance</span></a><a href="<?php echo $actual_link ?>#best-ulip-plan" class="tocContent"><span>Offline Insurance Plans from Kotak Life Insurance</span></a><a href="<?php echo $actual_link ?>#benefitsOfTerm" class="tocContent"><span>Benefits of Buying Term Insurance</span></a><a href="<?php echo $actual_link ?>#factorsAffecting" class="tocContent"><span>Factors Affecting Term Insurance</span></a><a href="<?php echo $actual_link ?>#whyChooseKotak" class="tocContent"><span>Why Choose Kotak Life?</span></a><a href="<?php echo $actual_link ?>#typeOfTerm" class="tocContent"><span>Types of Term Insurance Plans</span></a><a href="<?php echo $actual_link ?>#featureOfTerm" class="tocContent"><span>Features of Term Insurance Plans</span></a><a href="<?php echo $actual_link ?>#whyBuyTerm" class="tocContent"><span>Why Should You Buy a Term Insurance Plan?</span></a><a href="<?php echo $actual_link ?>#whoShouldBuy" class="tocContent"><span>Who Should Buy a Term Insurance Policy?</span></a><a href="<?php echo $actual_link ?>#whoShouldBuy" class="tocContent"><span>Testimonials for Kotak Term Insurance Policy</span></a></div>
                    <div><a href="<?php echo $actual_link ?>#howToChooseBestTerm" class="tocContent"><span>How to Choose the Best Term Insurance Plan?</span></a><a href="<?php echo $actual_link ?>#whyYouNeedTerm" class="tocContent"><span>Why do you need Term Insurance?</span></a><a href="<?php echo $actual_link ?>#termPlanSecure" class="tocContent"><span>How Does a Term Plan Secure Your Family’s Future?</span></a><a href="<?php echo $actual_link ?>#howToBuyTerm" class="tocContent"><span>How to Buy Term Insurance Plan Online?</span></a><a href="<?php echo $actual_link ?>#whyBuyTermOnline" class="tocContent"><span>Why Buy a Term Plan Online?</span></a><a href="<?php echo $actual_link ?>#termInsuranceRider" class="tocContent"><span>What is a Term Insurance Rider?</span></a><a href="<?php echo $actual_link ?>#rightTimeToBuy" class="tocContent"><span>When is the Right Time to Buy Term Insurance?</span></a><a href="<?php echo $actual_link ?>#payoutOptions" class="tocContent"><span>Payout Options in Term Life Insurance?</span></a><a href="<?php echo $actual_link ?>#howMuchPlanCover" class="tocContent"><span>How Much Term Insurance Plan Cover Do You Need?</span></a><a href="<?php echo $actual_link ?>#document-required-term-insurance" class="tocContent"><span>Documents Required for Term Insurance?</span></a><a href="<?php echo $actual_link ?>#insuranceTerminology" class="tocContent"><span>Term Insurance Terminology</span></a><a href="<?php echo $actual_link ?>#term-insurance-faqs" class="tocContent"><span>Term Insurance Frequently Asked Questions</span></a></div><a id="readMoreContent" class="tocReadMore">Read More</a>
                </div>
            </div>
        </section>
        <section class="hid" id="whatIsTermInsurance">
            <div class="midWrapper">
                <div class="whatIsTerm-grid">
                    <div>
                        ...
                        <p class="whatIsTerm-desc">Term insurance is one of the many types of life insurance that offers you coverage for a certain number of years or months, which can also be called a term. This type of life insurance provides your family much-needed financial security in case of an unfortunate event in exchange for a certain premium amount. In case the life insured's unfortunate death occurs during the policy term, the insurer provides the death benefit payout to the nominee, also called a life cover, which helps manage their expenses.</p><br>
                        <p class="whatIsTerm-desc">A term insurance policy is a very popular choice for people seeking all-around coverage at affordable premiums. These plans can be very useful if the financial security & the protection of your loved ones are your utmost consideration.</p><br>
            ...
            <div class="term-blog mt-30 new-saving-supporting">
            <div class="midWrapper">
                <div class="termblog-sick" id="term-blogs">
                    <div><a class="term-blg" href="https://www.kotaklife.com/term-insurance/2-crore-term-insurance">2 Crore Term Insurance<span class="suport-arrow"></span></a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/term-insurance/1-crore-term-insurance" target="_blank">1 Crore Term Insurance<span class="suport-arrow"></span></a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/term-insurance/1-5-crore-term-insurance" target="_blank">1.5 Crore Term Insurance<span class="suport-arrow"></span></a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/term-insurance/5-crore-term-insurance" target="_blank">5 Crore Term Insurance<span class="suport-arrow"></span></a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/term-insurance/75-lakh-term-insurance" target="_blank">75 Lakh Term Insurance<span class="suport-arrow"></span></a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/term-insurance/50-lakh-term-insurance" target="_blank">50 Lakh Term Insurance<span class="suport-arrow"></span></a></div>
                </div>
            </div>
        </div>
        </section>
        ...
        <section class="hid bg-fff" id="termInsuranceCalculator">
            <div class="midWrapper">
                ...
                <div class="termInsuranceCalc-cta"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-eterm?utm_source=organic&utm_medium=website&utm_campaign=l2category_page&utm_content=redbutton1">Calculate Premium Now</a></div>
            </div>
        </section>
                ...
                <div class="roww bestsavgsp">
                    ...
                    <div class="coll-md-9">
                        <div class="kotaksavcard accelcard op2 accelblock">
                            ...
                            <div class="view-Cta1">
                                <div class="onlinePlans-cta new_cta1"><a target="_blank" href="https://www.kotaklife.com/term-insurance/kotak-protect-india">Get Quote</a></div>
                            </div>
                        </div>
                        <div class="kotaksavcard accelcard op3">
                            ...
                            <div class="feats-buy text-left new-feats"><a target="_blank" href="https://www.kotaklife.com/term-insurance/kotak-term-plan">Know More</a></div>
                        </div>
                        <div class="kotaksavcard accelcard op4">
                            <div class="d-flex">
                                <div>
                                    <h3 class="accel" style="color:#036!important;font-size:28px!important">Kotak Saral Jeevan Bima</h3>
                                </div>
                            ...
                            <div class="feats-buy text-left new-feats"><a target="_blank" href="https://www.kotaklife.com/term-insurance/kotak-saral-jeevan-bima">Know More</a></div>
                        </div>
                        <div class="kotaksavcard accelcard op5">
                            ...
                            <div class="feats-buy text-left new-feats"><a target="_blank" href="https://www.kotaklife.com/term-insurance/kotak-health-maximiser">Know More</a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="gspaccbor">
                    <div class="accordion-div acc-div-mob accordion-btns">
                        ...
                        <div class="bor"><button name="assured" class="accordion" role="heading" aria-level="3">
                                <p class="bor-top-rad rad-top">Kotak Term Plan</p>
                            </button>
                            <div class="panel tab-detail mb-0 tab-align" style="">
        ...
        <section class="hid" id="benefitsOfTerm">
            <div class="midWrapper">
                <h2 class="benefitsOfTerm-title">Benefits of Buying Term Insurance</h2>
                <p class="benefitsOfTerm-desc">Term insurance is a very  important part of financial planning. It provides people with peace of mind & protection from unexpected events like death. Let us have a look at the benefits of term insurance.</p>
                ...
                <div class="factorsAffecting-banner">
                    ...
                    <div class="factorsAffecting-cta"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-eterm?utm_source=organic&utm_medium=website&utm_campaign=l2category_page&utm_content=getalifecoverof15cr">Buy Term Insurance</a></div>
                </div>
                <div class="mt-50">
        ...
        <section class="hid" id="factorsAffecting">
            <div class="midWrapper">
                ...
                <div class="factorsAffecting-banner">
                    ...
                    <div class="factorsAffecting-cta"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-eterm?utm_source=organic&utm_medium=website&utm_campaign=l2category_page&utm_content=makeyourfamilystronger">Get Quote</a></div>
                </div>
            </div>
        </section>
                ...
                <div class="midWrapper">
                    <div class="blueBg-grid">
                        <div class="textLeft">
                            ...
                            <div class="termPlan-cta2" style="text-align:left"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-eterm?utm_source=organic&utm_medium=website&utm_campaign=l2category_page&utm_content=choosetheplanthatworksbest">Buy Kotak e-Term online!</a></div>
                        </div>
        ...
        <section class="hid" id="typeOfTerm">
            <div class="midWrapper">
                ...
                <div class="typeOfTerm-cards">
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n"></div>
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n1"></div>
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n2"></div>
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n4"></div>
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n5"></div>
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n3"></div>
                    ...
                    <div class="typeOfTerm-card">
                        <div class="newterm ttip-icon1n6"></div>
        ...
        <section class="hid" id="howToChooseBestTerm">
            <div class="midWrapper">
                ...
                <div class="factorsAffecting-banner">
                    ...
                    <div class="factorsAffecting-cta"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-eterm?utm_source=organic&utm_medium=website&utm_campaign=l2category_page&utm_content=getyourpremiumback">Get Quote</a></div>
                </div>
            </div>
        </section>
        <section class="hid" id="whyYouNeedTerm">
            <div class="midWrapper">
                ...
                <p class="whyYouNeedTerm-desc">Term insurance is one of the best ways to safeguard the financial future of your family. It is one of the most simplest & affordable ways to make sure that your family is financially secure in an unfortunate event of death.</p>
        ...
        <section class="hid" id="termInsuranceRider">
            <div class="midWrapper">
                ...
                <p class="termInsuranceRider-desc">A<a class="inline-links" href="https://www.kotaklife.com/insurance-guide/protection/understanding-term-insurance-riders">term insurance rider</a>, or a term life insurance rider, is the extra feature you can add to your main life insurance policy. It provides additional coverage for a certain period of time called the "term," for which in exchange you need to pay an additional premium.</p>
        ...
        <section class="hid" id="rightTimeToBuy">
            <div class="midWrapper">
                ...
                <div class="factorsAffecting-banner">
                    ...
                    <div class="factorsAffecting-cta"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-eterm?utm_source=organic&utm_medium=website&utm_campaign=l2category_page&utm_content=get2crlifecover">Buy Now</a></div>
                </div>
            </div>
        </section>
                                ...
                                <div class="rating-stars text-left">
                                    ...
                                    <div class="stars-btn">
                                        <form id="my_radio_box">
                                            <div class="rating"><input type="radio" name="rating" value="Excellent" id="rating-5" checked="checked" disabled="disabled"><label for="rating-5"></label><input type="radio" name="rating" value="Best" id="rating-4" disabled="disabled"><label for="rating-4"></label><input type="radio" name="rating" value="Good" id="rating-3" disabled="disabled"><label for="rating-3"></label><input type="radio" name="rating" value="Fair" id="rating-2" disabled="disabled"><label for="rating-2"></label><input type="radio" name="rating" value="Satifactory" id="rating-1" disabled="disabled"><label for="rating-1"></label></div>
                                        </form>
        ...
        <section class="terms new-terms" id="terms-conditions">
            <div class="midWrapper"><button type="button" class="collapsible terms-txt whitespace-initial">Read about Tax benefits and Plan Disclaimer</button>
                <div class="content-col mb-0 tab-align li-disc terms-para">
                    ...
                    <p class="pl-0">Kotak Mahindra Life Insurance Company Ltd. Reg No. 107 | CIN: U66030MH2000PLC1285038th Floor, Plot # C- 12, G- Block, BKC, Bandra (E), Mumbai – 400051 | Toll Free: 1800 209 8800 (8 am to 10 pm) | Website: https://www.kotaklife.com | Email: kli.in/WECARE  Ref No: KLI/24-25/E-WEB/897</p>
...
<script>
    setTimeout(function() {
        var e = $(' <iframe id="kotakVideo" src="https://www.youtube.com/embed/cq1k0nYDe3Q" title="Basics of Term Insurance for Beginners | Insurance Fundamentals" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>');
        $("#kotVideo").append(e)
    }, 3e3)
    ...
    setTimeout(function() {
        $(".submitBtn").on("click", function() {
            $("input[name=rating]:checked").val() && (rating = $("input[name=rating]:checked").val()), $.ajax({
                ...
                success: function(t) {
                    var a = $.parseJSON(t);
                    $(".votedCount").html(a.feedbackratingdetailscount + " "), localStorage.setItem("term_rating", rating), $(".infoText").html("Thank you for your feedback!"), $(".rating").addClass("afterClick"), $(".submitDiv").fadeOut("slow"), $(".votedcheck").removeClass("d-none"), $(".votedcheck").addClass("d-block")
                }
            })
        })
    }, 3e3), $.ajax({
