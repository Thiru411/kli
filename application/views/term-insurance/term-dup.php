...
/* New css here for calculator */
.termInsuranceCalc-grid {
  display: grid;
...
.termCalc input[type=date],
.termCalc input[type=text] {
  width: 100%;
  height: 45px;
  line-height: 50px;
  padding: 0 25px;
            ...
            <div class="midWrapper">
                ...
                <div class="row">
                    <div class="coll-md-5">
                        ...
                        <p class="termDesc">Term insurance offers financial protection and safety to your family in case of your demise. Term insurance plans are one of the most affordable life insurance plans. It is the most crucial financial instrument that you must have in your portfolio.
                        <!--<span id="dots">...</span><span id="morecont">It is the most crucial financial instrument that you must have in your portfolio. You pay the insurer a premium to ensure financial cover (known as sum assured) that goes to your family (or nominee) if you pass away during the policy term.</span><span style="color: #ED3237 ;cursor: pointer;font-weight: 600;" onclick="readMoreBmi()" id="myBtn"> Read more</span>-->
                        </p>
      ...
      <section class="hid" id="termInsuranceCalculator">
        <div class="midWrapper">
          ...
          <div class="termInsuranceCalc-grid">
            ...
            <div class="termCalc">
              <div class="mb-3 form-group">
                <label for="coverAmt" class="form-label">Life Cover Amount</label>
                <input type="text" class="form-control" id="coverAmt" name="coverAmt" value="1,25,50,000" pattern="\d[0-9]*">
                <span id="name-error-container" class="error-container coverAmt"></span>
              </div>
              <div class="mb-3 form-group">
                <label for="dob" class="form-label">Date Of Birth</label>
                <input type="date" class="form-control" id="dob" name="dob">
                <span id="name-error-container" class="error-container age"></span>
              </div>
              <div class="genderRadioSec">
                <label>Gender</label>
                <div class="genderRadioWrp">
                  <div class="toolsCalcRadio">
                    <input name="gender"  class="gender" checked value="Male" aria-label="gender male" id="Male" type="radio">
                    <label for="male">Male</label>
                  </div>
                  <div class="toolsCalcRadio">
                    <input name="gender" id="female"   class="gender" value="Female" aria-label="gender female" type="radio">
                    <label for="female">Female</label>
                  </div>
                </div>
                <span id="name-error-container" class="error-container gender1"></span>

              </div>
              <div class="tobaccoRadioSec">
                <label>Tobacco</label>
                <div class="tobaccoRadioWrp">
                  <div class="toolsCalcRadio">
                    <input name="tobacco" class="tobacco" checked  value="true" aria-label="yes" id="yes" type="radio">
                    <label for="yes">Yes</label>
                  </div>
                  <div class="toolsCalcRadio">
                    <input name="tobacco" class="tobacco" value="false" aria-label="no" id="no" type="radio">
                    <label for="no">No</label>
                  </div>
                </div>
                <span id="name-error-container" class="error-container tobacco1"></span>
          ...
          <div class="termInsuranceCalc-cta">
            <a href="javascript:void(0)" class="temcalculator" onclick="temcalculator()">Calculate Premium Now</a>
          </div>
        </div>
      </section>
      <!-- Term Calculator ends here -->
            ...
            <div class="midWrapper">
                ...
                <div class="gspaccbor">
                    <div class="accordion-div acc-div-mob accordion-btns">
                        <div class="bor">
                            <button name="tulip" class="accordion bor-top-zero" role="heading" aria-level="3">
                        ...
                        <div class="bor">
                            <button name="assured" class="accordion" role="heading" aria-level="3">
...
function temcalculator() {
    var coverAmt = $('#coverAmt').val();
    var age = $('.age').text();
    var gender = $('.gender:checked').val();
    var tobacco = $('.tobacco:checked').val();
    var errorMessage = "";

    // Clear any previous error messages
    // Validation
    if (coverAmt === "" || coverAmt <= 0) {
        errorMessage = "Please enter a valid cover amount.";
        $('.coverAmt').text(errorMessage);
        $('.coverAmt').focus();
        return false;
    }
    ...
    if (age === "" || age < 18) {
        errorMessage = "Please Select Greater Than 18 Years.";
        $('.age').text(errorMessage);
        $('.age').focus();
        return false;
    }
    if (gender === undefined) {
        errorMessage = "Please select your gender.";
        $('.gender1').text(errorMessage);  // Assuming error message will be placed after the last radio button
        $('.gender1').focus();
        return false;
    }

    if (tobacco === undefined) {
        errorMessage = "Please select your tobacco usage.";
        $('.tobacco1').text(errorMessage);  // Assuming error message will be placed after the last radio button
        $('.tobacco1').focus();
        return false;
    }
    ...
    $.ajax({
        url: '<?=base_url()?>integrationapi',  // Replace with the path to your server-side script
        type: 'POST',
        data: {
            coverAmt: coverAmt,
            age: age,
        ...
        success: function(response) {
            ...
            $('#responseMessage').html('Something is wrong');
