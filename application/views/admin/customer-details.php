  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url() ?>advisors-for-life/admin/customer-details">Customer Details</a></li>
      ...
      <section class="content">
        <div class="container fluid">
        <form role="form" id="quickForm" name="myForm" action="<?= base_url() ?>advisors-for-life/admin/customer-details" method="get">
