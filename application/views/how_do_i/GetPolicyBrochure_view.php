<section> 
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01">
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy brochure','label':'tab|Protection Plans'});" href="<?=base_url()?>how-do-i/get-policy-brochure" class="selected">Protection Plans</a></li>
    ...
    <div class="midWrapper">
	  ...
	  <div class="topDesc">
		...
		<ul class="reportUL" id="daf_proposalForm">
         ...
         <a href="javascript:;" data-event="event download forms" data-action="Load More" data-label="button|<?php echo strtolower('Get Policy Brochure|Protection Plans'); ?>" class="link ga_track" id="load_more" alt="dafPolicyServicing">Load more</a></div>
    </div>
  </article>
</section>
<script>
