<section> 
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01">
      ...
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'download application form','label':'tab|policy servicing'});"  href="<?=base_url()?>how-do-i/policy-servicing-forms">policy servicing forms </a></li>
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'download application form','label':'tab|request for major revival of policy forms'});"  href="<?=base_url()?>how-do-i/major-revival-policy-forms" class="selected">request for major revival of policy forms</a></li>
  ...
  <article class="navWrapper downloadAppWrap">
    <div class="midWrapper">
      <div class="claimWrapper">
        <div class="topDesc">
          <h2>Request for Major Revival of Policy Forms</h2>
        </div>
        <ul class="reportUL" id="daf_proposalForm">
		
        </ul>
		 <a href="javascript:;" data-event="event download forms" data-action="Load More" data-label="button|<?php echo strtolower('Download Application Form|Request for Major Revival of Policy Forms'); ?>" class="link ga_track" id="load_more" alt="dafPolicyServicing">Load more</a></div>
    </div>
  </article>
</section>
<script>
