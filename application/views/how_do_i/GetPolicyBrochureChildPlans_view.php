<section> 
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01">
      ...
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy brochure','label':'tab|Child Plans'});" href="<?=base_url()?>how-do-i/brochure-child-plans" class="selected">Child Plans</a></li>
  ...
  <article class="navWrapper">
    <div class="midWrapper">
      <div class="claimWrapper">
        <div class="topDesc">
          <h2 id="no_plans">Child Plans</h2>
        </div>
		<ul class="reportUL" id="daf_proposalForm">
		
        </ul>
         <a href="javascript:;" data-event="event download forms" data-action="Load More" data-label="button|<?php echo strtolower('Get Policy Brochure|Child Plans'); ?>" class="link ga_track" id="load_more" alt="dafPolicyServicing">Load more</a></div>
    </div>
  </article>
</section>
<script>
