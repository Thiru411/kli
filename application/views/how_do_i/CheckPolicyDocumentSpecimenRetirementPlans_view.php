<section> 
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01 fundTabUL012">
      ...
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy document speciman','label':'tab|Retirement Plans'});" href="<?=base_url()?>how-do-i/check-policy-document-specimen-retirement-plans" class="selected">Retirement Plans</a></li>
    ...
    <div class="midWrapper">
      <div class="claimWrapper">
        ...
        <ul class="reportUL" id="daf_proposalForm">
		 ...
		 <a href="javascript:;" data-event="event download forms" data-action="Load More" data-label="button|<?php echo strtolower('Check Policy Document Specimen|Retirement Plans'); ?>" class="link ga_track" id="load_more" alt="dafPolicyServicing">Load more</a></div>        
    </div>
  </article>
</section>
<script>
