<section> 
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01 fundTabUL012">
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy document speciman','label':'tab|Protection Plans'});" href="<?php echo base_url()?>how-do-i/check-policy-document-specimen">Protection Plans</a></li>
      ...
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy document speciman','label':'tab|Withdrawn Products'});" href="<?php echo base_url()?>how-do-i/check-policy-document-specimen-withdrawn-products" class="selected">Withdrawn Products</a></li>
  ...
  <article class="navWrapper">
    <div class="midWrapper">
      <div class="claimWrapper">
        <div class="topDesc">
          <h2>Withdrawn Products</h2>
        </div>
        <ul class="reportUL" id="daf_proposalForm">
		
        </ul>
         <a href="javascript:;" data-event="event download forms" data-action="Load More" data-label="button|<?php echo strtolower('Check Policy Document Specimen|Withdrawn Products'); ?>" class="link ga_track" id="load_more" alt="dafPolicyServicing">Load more</a></div> 
    </div>
  </article>
</section>
<script>
