<section> 
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01 fundTabUL012">
      ...
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy document speciman','label':'tab|Savings & Investment Plans'});"  href="<?=base_url()?>how-do-i/check-policy-document-specimen-savings-and-investments" class="selected">Savings & Investment Plans</a></li>
      ...
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $gaCat;?>', 'action':'get policy document speciman','label':'tab|Child Plans'});"  href="<?=base_url()?>how-do-i/check-policy-document-specimen-child-plans">Child Plans</a></li>
  ...
  <article class="navWrapper">
    <div class="midWrapper">
      <div class="claimWrapper">
       ...
       <a href="javascript:;" data-event="event download forms" data-action="Load More" data-label="button|<?php echo strtolower('Check Policy Document Specimen|Savings & Investment Plans'); ?>" class="link ga_track" id="load_more" alt="dafPolicyServicing">Load more</a></div> 
    </div>
  </article>
</section>
<script>
