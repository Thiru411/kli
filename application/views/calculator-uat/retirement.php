    ...
    <div class="pageWrapper">
        <section id="retirement_calculator" class="bg_light">
            <div class="container">
                ...
                <div class="retirement_div">
                        <p class="retirement_text">Retirement is a phase in life that every working individual must prepare for. It is the time when people want to sit back, relax, and enjoy the fruits of their labor without worrying about work-related stress. However, without proper planning, retirement can turn into a stressful period. One way to make sure that you have enough funds to lead a comfortable life in your golden years is to use a retirement calculator. <span id="dots">...</span>
                        <span class="retirement_text"  id="more">A retirement calculator is a tool that helps individuals estimate how much money they will need to save for their retirement. It takes into account various factors such as the individual's age, income, expenses, and investment returns. With this information, the calculator then projects how much money the individual will have at retirement and whether it will be enough to meet their retirement needs.</span> <span style="color: #ED3237 ;cursor: pointer;font-weight: 600; font-size:17px" onclick="readMoreFD()" id="myBtn"> Read more</span>
                    </p>
                    </div>
                ...
                <div class="container">
                    <div class="secWarp">
                        <div class="leftSec">
                            ...
                            <p class="planningCalcDesc">As already stated, a retirement planning calculator is a tool that helps individuals estimate how much money they will need to save for retirement and how much income they can expect to receive from their savings. Retirement planning calculators also help individuals estimate the amount of money they can expect to receive from their savings during retirement.</p><br>
            ...
            <div class="retirementCalcWork_bg">
                <div class="container">
                    ...
                    <div class="Steps">
                        ...
                        <div class="stepsCont"> <span class="tick"></span>
                            <div class="stepWarp">
        ...
        <section id="benefitRetirement">
            <div class="container">
                ...
                <p class="benefitRetirementDesc">Retirement is an important phase of life, where you can finally enjoy the fruits of your labor and take some time off to relax and enjoy your golden years. However, it is essential to plan for retirement, as it can be a significant financial burden without proper preparation. A retirement calculator can help you plan and prepare for this phase of life.</p><br>
        ...
        <section id="otherCalc">
          <div class="midWrapper">
            <div class="otherCalcCard">
              ...
              <ul class="calculatorCardList retireslick">
            ...
            <div class="container">
                <div class="accordSec">
                    ...
                    <div class="accordList">
                        ...
                        <div class="accordItem">
                            <div class="accordLinks">
                                <h3><a href="javascript:void(0);"><span>5</span>What are some of the most recommended investment avenues?</a></h3>
                            </div><span class="icon"></span>
                            <div class="accordDesc" style="display:none">
...
if ($(window).width() > 768) {
  ...
  var $slickElementgspnew11 = $('.retireslick');
