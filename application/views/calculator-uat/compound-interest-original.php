					...
					<div class="col-lg-5 m-no-padding">
						<div class="card card_middle p-0">
							<div class="card_body">
								...
								<canvas id="compound_interest_chart" height="220" class="compound_interest_chart"></canvas><a target="_blank" href="buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=calculators&utm_campaign=compounding&utm_content=investnow" class="btn_primary m-0">Invest Now</a>
							</div>
						</div>
					</div>
				</div>
...
<path d="M24.633 14.8904L16.9053 22.8202C16.8104 22.919 16.6973 22.9975 16.5726 23.051C16.4479 23.1046 16.3141 23.1321 16.1789 23.1321C16.0437 23.1321 15.9099 23.1046 15.7852 23.051C15.6605 22.9975 15.5474 22.919 15.4525 22.8202L11.8463 19.1196C11.6536 18.9219 11.5454 18.6538 11.5454 18.3742C11.5454 18.0947 11.6536 17.8265 11.8463 17.6288C12.0389 17.4311 12.3002 17.3201 12.5727 17.3201C12.8451 17.3201 13.1064 17.4311 13.2991 17.6288L16.1789 20.5787L23.1802 13.3996C23.3728 13.2019 23.6341 13.0908 23.9066 13.0908C24.179 13.0908 24.4403 13.2019 24.633 13.3996C24.8256 13.5973 24.9338 13.8654 24.9338 14.145C24.9338 14.4246 24.8256 14.6927 24.633 14.8904Z" fill="#ED1C24"/>
					...
					<div class="rightSec">
						<picture>
							<source media="(min-width:767px)" srcset="assets/images/undraw-calculator.webp" /><img data-src="assets/images/undraw-calculator-mob.webp" src="assets/images/undraw-calculator-mob.webp"  class="lzy_img"height="100%" width="100%"  alt="compundImg" />
						</picture>
					</div>
				</div>
			</div>
					...
					<div class="accordList">
						<div class="accordItem">
							<div class="accordLinks">
								<h3> <a href="javascript:void(0);"> <span>1</span>What is compounding?</a></h3>
						...
						<div class="accordItem">
							<div class="accordLinks">
								<h3> <a href="javascript:void(0);"> <span>2</span>What is compound interest?</a></h3>
							</div><span class="icon"></span>
							<div class="accordDesc">
						...
						<div class="accordItem">
							<div class="accordLinks">
								<h3> <a href="javascript:void(0);"> <span>3</span>How is compound interest calculated?</a></h3>
							</div><span class="icon"></span>
							<div class="accordDesc">
						...
						<div class="accordItem">
							<div class="accordLinks">
								<h3> <a href="javascript:void(0);"> <span>4</span>What is the difference between simple interest and compound interest?</a></h3>
							</div><span class="icon"></span>
							<div class="accordDesc">
						...
						<div class="accordItem">
							<div class="accordLinks">
								<h3><a href="javascript:void(0);"> <span>5</span>What is power of compounding?</a></h3>
							</div><span class="icon"></span>
							<div class="accordDesc">
						...
						<div class="accordItem">
							<div class="accordLinks">
								<h3> <a href="javascript:void(0);"> <span>6</span>What is the formula for calculating compound interest?</a></h3>
							</div><span class="icon"></span>
							<div class="accordDesc">
						...
						<div class="accordItem">
							<div class="accordLinks">
								<h3><a href="javascript:void(0);"> <span>7</span>What is the difference between Cumulative and Compound Interest?</a></h3>
							</div><span class="icon"></span>
							<div class="accordDesc">
