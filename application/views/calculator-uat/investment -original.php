							...
							<div class="col-lg-5 m-no-padding"> 
								<div class="card card_middle">
									<div class="card_body">
										...
										<canvas id="investment_chart" height="240" class="investment_chart"></canvas><a target="_blank" href=base_url."/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=calculators&utm_campaign=ulip&utm_content=investnow" class="btn_primary">Invest Now</a>
									</div>
								</div>
							</div>
						</div>
