        ...
        <section id="sip_calculator">
          <div class="container">
            ...
            <div class="headSection">
              ...
              <p class="sipDesc">Systematic Investment Plan or SIP is a method of disciplined investment. The SIP calculator will help
you relook at the investment strategy and aid you in making better financial returns. Check out the
use of SIP calculator and everything you wanted to know about it. <span id="dots">...</span><span id="more">
                  SIPs or Systematic Investment Plans is a method of investing in mutual funds.
Mutual funds are instruments that can help grow your investments multi-fold over long-term. But
what about understanding the returns on these instruments? For that, you can use various financial
tools like SIP calculator.</span><span style="color: #ED3237 ;cursor: pointer;font-weight: 600;" onclick="readMore()" id="myBtn"> Read more</span></p>
            </div>
              ...
              <div class="col-lg-12 m-no-padding">
                <div class="sipCard">
                  ...
                  <div class="sipGraph">
                    ...
                    <a target="_blank"
                      href=" https://www.kotaklife.com/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=website&utm_campaign=sipcalculator&utm_content=investnow"
              ...
              <ul class="calculatorList">
                <li>
                  <a href="https://www.kotaklife.com/financial-tools-calculators/ulip-calculator">
                    <img src="assets/images/calculator/sip-calculator/Income-Tax-Calculator.svg" />
                    ULIP Calculator</a>
                </li> -->
                <!-- <li><span></span><a href="https://www.kotaklife.com/financial-tools-calculators/income-tax-calculator">Income Tax Calculator</a></li> -->
                <!-- <li class="secondCard">
                  <a href="https://www.kotaklife.com/financial-tools-calculators/compound-interest-calculator">
                    <img src="assets/images/calculator/sip-calculator/Compound-Interest-Calculator.svg" />
                    Compound Interest Calculator</a>
                </li>
                <li>
                  <a href="https://www.kotaklife.com/financial-tools-calculators/retirement-calculator">
                  <img src="assets/images/calculator/sip-calculator/Retirement-Planning-Calculator.svg" />
 ...
 <section id="otherCalc">
          <div class="midWrapper">
            <div class="otherCalcCard">
              ...
              <ul class="calculatorCardList sipslick">
                 <li>
                  <a href="https://www.kotaklife.com/financial-tools-calculators/ulip-calculator">
...
if ($(window).width() > 768) {
  ...
  var $slickElementgspnew11 = $('.sipslick');
