    ...
    <body>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<table id="report-table" class="table table-bordered table-striped table-hover">
						<thead>
							<tr><td>Entry ID</td><td>Name</td><td>Email</td><td>Keyword</td><td>Date</td></tr>
						</thead>
						<tbody>
						</tbody>
					</table>
		...
		$(document).ready(function() {
			...
			$("#download").on("click", function(){
				...
				var url = '<?php echo site_url("report/user_glossary_export_CSV") ?>';
				postURL( url+'?'+data);
			});
			...
			table = $('#report-table').DataTable({
				...
				"ajax": {
					url : "<?php echo site_url("report/user_glossary_report_page") ?>",
					type : 'POST'
				},
				"columnDefs": [
					{ type : 'date', targets : [4] }
