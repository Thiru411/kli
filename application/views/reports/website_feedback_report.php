...
<body>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table id="report-table" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr><td>Entry ID</td><td>Meet Your Needs</td><td>Easy To Find</td><td>Time Taken</td><td>Visually Appealing</td><td>Easy To Understand</td><td>Recommend Website</td><td>Name</td><td>Email</td><td>Phone</td><td>City</td><td>Date</td></tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        ...
        var data = $.param($('#report-table').DataTable().ajax.params());
                var url = '<?php echo site_url("report/website_feedback_export_CSV") ?>'; postURL(url + '?' + data);
        });
                fetch_data('no');
        ...
        "pageLength": 10,
                ...
                "ajax": {
                url: "<?php echo site_url("report/website_feedback_report_page") ?>",
                        data: {
