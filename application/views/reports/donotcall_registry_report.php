        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table id="report-table" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr><td>Entry ID</td><td>Name</td><td>Phone</td><td>Email</td><td>City</td><td>Date</td></tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#download").on("click", function () {
                ...
                var url = '<?php echo site_url("report/donotcall_registry_export_CSV") ?>';
                postURL(url + '?' + data);
            });
            ...
            function fetch_data(is_date_search, start_date = '', end_date = ''){
                table = $('#report-table').DataTable({
                    ...
                    "ajax": {
                        url: "<?php echo site_url("report/donotcall_registry_report_page") ?>",
                        data: {
