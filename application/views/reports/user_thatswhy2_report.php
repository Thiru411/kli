        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table id="report-table" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr><td>Entry ID</td><td>Name</td><td>Mobile</td><td>City</td><td>Source</td><td>Utm source</td><td>Utm medium</td><td>Campaign Type</td><td>Date</td></tr>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#download").on("click", function () {
                ...
                var url = '<?php echo site_url("campaign-report-download/thatswhy2") ?>';
                postURL(url + '?' + data);
            });
            fetch_data('no');
            function fetch_data(is_date_search, start_date = '', end_date = ''){
                table = $('#report-table').DataTable({
                    ...
                    "ajax": {
                        url: "<?php echo site_url("campaign-report-page/thatswhy2") ?>",
                        data: {
