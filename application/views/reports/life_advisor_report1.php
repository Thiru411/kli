    ...
    <body>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<table id="report-table" class="table table-bordered table-striped table-hover">
						<thead>
							<tr><td>Entry ID</td><td>Name</td><td>Phone</td><td>City</td><td>Customer Type</td><td>Plan Type</td><td>Date</td></tr>
						</thead>
						<tbody>
						</tbody>
					</table>
		...
		$(document).ready(function() {
			...
			$("#download").on("click", function(){
				...
				var url = '<?php echo site_url("report/life_advisor_export_CSV") ?>';
				postURL( url+'?'+data);
			});
			...
			table = $('#report-table').DataTable({
				...
				"ajax": {
					url : "<?php echo site_url("report/life_advisor_report_page") ?>",
					type : 'POST'
				},
				"columnDefs": [
					{ type : 'date', targets : [4] }
