 ...
 <!-- breadcrumb Start -->
  ...
  <div class="tabWrap">
    <ul class="fundTabUL fundTabUL01 fundTabUL012">
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $categoryGA;?>', 'action':'get policy faqs','label':'tab|Policy Faqs'});" href="<?php echo base_url()?>insurance-guide/policy-faqs">General FAQs</a></li>
      <li><a onClick="dataLayer.push({'event':'event tab', 'category':'<?php echo $categoryGA;?>', 'action':'get policy related faqs','label':'tab|Policy Related Faqs'});" href="<?php echo base_url()?>insurance-guide/policy-related-faqs" class="selected">Policy Related FAQs</a></li>
    </ul>
  </div>
  ...
  <!-- FAQs End --> 
<input type="hidden" id="faqType" value="2">
