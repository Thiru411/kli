<header class="main_header">
    <nav class="navbar navbar-expand-lg navbar-light p-0" style="width:385px;height:40px">
      <div class=" logo">
        <a class="navbar-brand logo" href="<?php echo base_url()?>"><img data-src="<?php echo base_url()?>assets/mobile/images/kotak-logo.png" alt="Kotak Life Insurance - Logo" class="img-fluid lzy_img" height="20px" width="90px"></a>
      </div>
