...
<style>
    ...
    @media screen and (max-width:468px) {
        .ulipdownload {
            background-position: -1713px -3022px
        }
            ...
            <div class="midWrapper">
                <div class="topSectionGrid">
                    <div>
                        ...
                        <p class="topSection-desc">Unit-Linked Insurance Plan (ULIPs) is a type of life insurance plan that provides an opportunity to grow your money. ULIPs offer the long term financial protect your family through life cover. These plans are very popular among individuals as they help in gaining financial security and long-term capital growth.</p><br>
                        <p class="topSection-desc">ULIPs offer an opportunity for fund creation, and tax benefits to the policy owner. They also provide a wide and customizable road to financial planning and protection.</p>
                    </div>
                    <div class="ulipCard">
        ...
        <section class="saving-blog mt-30 newulip newalignulip">
            <div class="midWrapper">
                <div class="termblog-sick" id="saving-blogs">
                    <div><a class="term-blg" href="https://www.kotaklife.com/ulip-plans/ulip-returns-in-5-years">ULIP Returns in 5 Years</a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/ulip-plans/ulip-returns-in-10-years" target="_blank">ULIP Returns in 10 Years</a></div>
                    <div><a class="term-blg" href="https://www.kotaklife.com/ulip-plans/ulip-returns-in-15-years" target="_blank">ULIP Returns in 15 Years</a></div>
                    ...
                    <div class="feats-sec kotat-online">
                        ...
                        <div class="roww mg-30 kotaksavcard list-1">
                            <div class="coll-md-6">
                                ...
                                <div class="ulip-cta"><a rel="nofollow" target="_blank" href="https://www.kotaklife.com/life-insurance-plans/#/buy-e-invest-ulip-plan-online?utm_source=ulip_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=product_card" title="invest in ULIP">Invest in ULIP</a></div>
                            </div>
            ...
            <div class="midWrapper">
                ...
                <div class="whyChooseKotakUlip-grid newchoosegrid">
                    <div class="whyChooseKotakUlip-cards">
                        ...
                        <h3 class="whyChooseKotakUlip-subTitle">Customized Investment Options</h3> -->
                        <!-- <p class="whyChooseKotakUlip-subDesc">With Kotak e-Invest you can choose from a wide range of funds based on your risk appetite and financial goals. It offers something for everyone, whether you prefer a conservative approach or are willing to take on higher risks for higher returns. It also provides different fund options like equity funds, debt funds, and balanced funds making sure your investment stays aligned to your goals.</p> -->
                         <img src="/assets/images/ulip-plan/bankimg.png" class="bank-img">
                         
                    </div>
                    <div class="whyChooseKotakUlip-cards">
                       <div class="whyChooseKotakUlip-flexR whynewchoose1">
                          <div class="enjoynew"> <p>Enjoy the dual benefits of protection and growth with Kotak e-Invest plan.</p><a class="margincta" href="https://www.kotaklife.com/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=whychoose">Invest today</a></div>
                       </div>
                        </div>
                </div>
            </div>
                ...
                <div class="midWrapper">
                    <div class="whyInvestinUlip-grid">
                        ...
                        <div>
                            ...
                            <div class="whyInvestinUlip-cta"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=why-invest-in-ulip">Invest in ULIP</a></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    setTimeout(function() {
        $(".submitBtn").on("click", function() {
            $("input[name=rating]:checked").val() && (rating = $("input[name=rating]:checked").val()), $.ajax({
                ...
                success: function(a) {
                    var t = $.parseJSON(a);
                    $(".votedCount").html(t.feedbackratingdetailscount + " "), localStorage.setItem("ulip_rating", rating), $(".infoText").html("Thank you for your feedback!"), $(".rating").addClass("afterClick"), $(".submitDiv").fadeOut("slow"), $(".votedcheck").removeClass("d-none"), $(".votedcheck").addClass("d-block")
                }
            })
        })
    }, 3e3), $.ajax({
