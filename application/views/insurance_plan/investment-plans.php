    ...
    <div class="midWrapper">
        <div class="investmentGrid">
            ...
            <div>
                ...
                Investment plans are financial products that help people build wealth for their future. The best investment plans allow them to regularly & systematically invest in the different funds over time to help them reach their financial goals.

                </p>
                <br/>
                <p class="investmentDesc">
                An investment plan is a guide for deciding where to invest your money, how much to invest, and for how long. It starts with setting clear goals, like saving for retirement, buying a house, paying for education, or growing wealth.
                    <span id="dots">...</span>
                    <span id="more">
                    It helps you with structure & direction to navigate financial markets very confidently, aiming for a secure your financial future.
                    </span>
...
<section id="investmentPlans">
    <div class="midWrapper">
        ...
        <div class="investmentFlex-start">
            ...
            <div>
                <h2 class="investmentSubTitle">Low-risk Investment</h2>
                <p class="investmentDesc">
        ...
        <div>
            <div class="whatInvestmentPlan-cards">
                ...
                <div>
                    <h3 class="investmentSubTitles">Guaranteed Savings Plan</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Tax Saving Fixed Deposits</h3>
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Sukanya Samriddhi Yojana (SSY)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Public Provident Fund (PPF)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Senior Citizen Savings Scheme (SCSS)</h3>
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Retirement Plans</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">National Pension Scheme (NPS)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Post Office Monthly Income Scheme (POMIS)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">National Savings Certificate (NSC)</h3>
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Employee Provident Fund (EPF)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Atal Pension Yojana (APY)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Gold Investment</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Real Estate Investment</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Life Insurance</h3>
                    <p class="investmentDesc">
        ...
        <div class="investmentFlex-start">
            ...
            <div>
                <h2 class="investmentSubTitle">Medium Risk Investment</h2>
                <p class="investmentDesc">
        ...
        <div>
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Monthly Income Plans (MIPs)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Hybrid-Debt Oriented Funds</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Arbitrage Funds</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Exchange-Traded Funds (ETFs)</h3>
                    <p class="investmentDesc">
        ...
        <div class="investmentFlex-start">
            <div class="investplansprite investimg1"></div>
            <div>
                <h2 class="investmentSubTitle">High Risk Investment</h2>
                <p class="investmentDesc">
        ...
        <div>
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Unit Linked Insurance Plans (ULIPs)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Initial Public Offerings (IPOs)</h3>
                    <p class="investmentDesc">
            ...
            <div class="whatInvestmentPlan-cards">
                <div class="investplansprite investimg4"></div>
                <div>
                    <h3 class="investmentSubTitles">Direct Equity</h3>
                    <p class="investmentDesc">
...
<section id="investmentPlans">
    <div class="midWrapper">
        <h2 class="investmentTitle">What Documents are Required to Buy an Investment Plan in India</h2>
        <p class="investmentDesc">
