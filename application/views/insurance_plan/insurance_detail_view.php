    ...
    <article>
     ...
     $eventGA='';$labelGA='';
		if(isset($planMainInfo->plan_buy_online_url) && $planMainInfo->plan_buy_online_url != '') { ?><?php
            ...
            $labelGA =  'buy online';
            //GA code Variables
          ?><?php if($planMainInfo->title=='Kotak Guaranteed Savings Plan') {?><a class=redBtn href="<?=base_url()?>buy-kotak-guaranteed-savings-plan-online/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=productpagecta&utm_content=productpage" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank rel=follow>Invest in Kotak Guaranteed Savings Plan</a><?php } else if($planMainInfo->title=='Kotak e-Term Plan (Term Life Insurance)'){?><a class=redBtn href="<?php echo isset($planMainInfo->plan_buy_online_url) ? $planMainInfo->plan_buy_online_url : '' ?>" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank rel=follow>Term Insurance Calculator</a><?php } else if($planMainInfo->title=='Kotak Health Shield' || $planMainInfo->title=='Kotak Lifetime Income Plan'){ ?><?php  }else if($planMainInfo->title=='Kotak e-Invest '){?><a class=redBtn href="<?=base_url()?>buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=website&utm_campaign=productpagecta" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank rel=follow>Buy Online</a><?php  }else if($planMainInfo->title=='Kotak e-Term Plan '){ ?><a class=redBtn href="<?=base_url()?>buy-online-term-insurance/?utm_source=organic&utm_medium=website&utm_campaign=productpagecta" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank rel=follow>Calculate term insurance premium</a><?php }  else {?><a class=redBtn href="<?=base_url()?>buy-online-term-insurance/?utm_source=organic&utm_medium=website&utm_campaign=productpagecta&utm_content=productpage" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank rel=follow>Buy Term Online</a><?php } ?><?php }  else if($planMainInfo->title=='Kotak Guaranteed Savings Plan'){?><a class=redBtn href="<?=base_url()?>buy-kotak-guaranteed-savings-plan-online/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=top_menu" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank>Buy Online</a><?php } else if($planMainInfo->title=='Kotak Assured Savings Plan'){ ?><a class="redBtn detbtn ksap-btn mb-30 online-dnone" href="<?=base_url()?>buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=productpagecta&utm_content=productpage">Invest in Kotak Assured Savings Plan</a><?php  }  else if($planMainInfo->title=='Kotak Assured Pension'){ ?><a class="redBtn detbtn ksap-btn mb-30 online-dnone" href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-assured-pension?utm_source=kap_organic&utm_medium=website&utm_campaign=productpagecta&utm_content=productpage">Buy Online</a><?php  }else if($planMainInfo->title=='Kotak Protect India'){ ?><?php  }else if($planMainInfo->title=='Kotak Lifetime Income Plan'){ ?>
                <?php  }else if($planMainInfo->title=='Kotak Guaranteed Fortune Builder'){ ?><a class=redBtn href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-guaranteed-fortune-builder?utm_source=kgfb_organic&utm_medium=website&utm_campaign=productpagecta&utm_content=productpage" onclick='dataLayer.push({event:"<?php echo $eventGA; ?>",category:"<?php echo $categoryGA; ?>",action:"<?php echo $actionGA; ?>",label:"<?php echo $labelGA; ?>"})' target=_blank>Invest in Kotak Guaranteed Fortune Builder</a><?php }} ?><?php //echo "testing".$planMainInfo->title?><?php echo isset($planMainInfo->plan_description) ? $planMainInfo->plan_description : '' ?>
