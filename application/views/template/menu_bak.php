            ...
            <div id="accordion-4" class="accordion-section-content">
              <ul class="third_navUL third_navUL3">
                <li>
                  ...
                  <ul class="third_navUL_subnav">
                    <li><a itemprop="url" href="<?php echo base_url()?>insurance-plans/protection-plans/kotak-e-term-plan" data-customer-type="new_customer" class="customer-type"><span itemprop="name">Kotak e-Term Plan</span></a><a href=base_url."/buy-online-term-insurance/?utm_source=organic&utm_medium=website&utm_campaign=top_menu&utm_content=insurance_plans" class="menu-buy">Buy Online</a></li>
                ...
                <li>
				  ...
				  <li><a itemprop="url" href="<?php echo base_url()?>online-plans/ulip-plan/kotak-e-invest" data-customer-type="new_customer" class="customer-type"><span itemprop="name">Kotak e-Invest Plan</span> </a><a href=base_url."/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=website&utm_campaign=top_menu&utm_content=insurance_plans" class="menu-buy">Buy Online</a></li>
                ...
                <li>
                  <a itemprop="url" href="<?php echo base_url()?>insurance-plans/health-plans" data-customer-type="new_customer" class="customer-type"><img alt="" src="assets/images/menu-ProtectionPlan.png"><span itemprop="name">Health Plans</span></a>
                  <ul class="third_navUL_subnav">
                    <li><a itemprop="url" href="<?php echo base_url()?>insurance-plans/health-plans/kotak-health-shield" data-customer-type="new_customer" class="customer-type"><span itemprop="name">Kotak Health Shield</span></a> <!--<a href=base_url."/buy-health-insurance-online/#/landing?utm_source=organic&utm_medium=website&utm_campaign=top_menu&utm_content=insurance_plans" class="menu-buy">Buy Online</a>--></li>
                  </ul>
                  <!-- <a itemprop="url"  href="<?php echo base_url()?>insurance-plans/protection-plans" class="viewAll"><span itemprop="name">View all protection plans</span></a>  -->
               </li>
				      <li>
	...
	<li>
					...
					<li>
						...
						<ul class="third_navUL_subnav">
							...
							<li><a rel="follow" itemprop="url"  href="<?php echo base_url() ?>financial-tools-calculators/ulip-calculator/" target="_blank" class=""><span itemprop="name">ULIP Calculator</span></a></li>
							<li><a rel="follow" itemprop="url"  href="<?php echo base_url() ?>financial-tools-calculators/income-tax-calculator" target="_blank" class=""><span itemprop="name">Income Tax Calculator</span></a></li>
							<li><a rel="follow" itemprop="url"  href="<?php echo base_url() ?>financial-tools-calculators/compound-interest-calculator" target="_blank" class=""><span itemprop="name">Compound Interest Calculator</span></a></li>
							<li><a rel="follow" itemprop="url"  href="<?php echo base_url() ?>financial-tools-calculators/retirement-calculator" target="_blank" class=""><span itemprop="name">Retirement Calculator</span></a></li>
                         </ul>
                    </li>					
                  </ul>				  
                </div>
			   ...
			   <li class=""><a rel="follow" itemprop="url" onclick="open_online()" class="open_online"  data='Buy Online' href="javascript:void(0);"><span itemprop="name">Calculate Premium</span></a></li>
			  ...
			  <li class="thirdLevel <?php check_menu_active(1, HDI_MODULE_LINK) ?>">
                ...
                <div class="third_navWrap">
                  <ul class="third_navUL third_navUL03">
                    ...
                    <li><a itemprop="url"  target="_blank" href="https://customer.kotaklifeinsurance.com/ocm"  rel="follow" class="<?php check_menu_active(2, 'file-claim') ?>"><img alt="Icon for filing an insurance claim" src="assets/images/menu-FileAClaim.png"><span itemprop="name">File a Claim</span></a></li>
                  ...
                  <ul class="third_navUL third_navUL3">
                    <li>
                      ...
                      <ul class="third_navUL_subnav">
                        ...
                        <li><a itemprop="url"  href="<?php echo base_url(IP_MODULE_LINK.'/protection-plans/kotak-e-term-plan') ?>" data-customer-type="existing_customer" class="customer-type <?php check_menu_active(3, 'kotak-e-term-plan') ?>"><span itemprop="name">Kotak e-Term Plan</span></a><a class="menu-buy" href=base_url."/buy-online-term-insurance/#/landing?utm_source=organic&utm_medium=website&utm_campaign=top_menu&utm_content=insurance_plans">Buy Online</a></li>
						 <li><a itemprop="url" href=base_url."/insurance-plans/protection-plans/kotak-term-plan"><span itemprop="name">Kotak Term Plan</span></a></li>
                          <li><a itemprop="url" href=base_url."/insurance-plans/protection-plans/kotak-saral-jeevan-bima"><span itemprop="name">Kotak Saral Jeevan Bima</span></a></li>
  ...
  ?>
    <ul class="fixedUL <?php echo $cls;?>">
		<?php if($cusType=="new_customer"){ /*$gaCat = "New Customer";*/ ?>
		 <li><a href="<?php echo base_url().'how-do-i/pay-my-premium'?>"  class="get-premium">Pay Premium</a></li>
