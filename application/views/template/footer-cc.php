...
<footer>
  <div class="midWrapper">
    <div class="plans roww">
      ...
      <ul class="plan-list">
          ...
          <li> <a href="<?=base_url?>/buy-online-term-insurance ">Term Insurance Quote </a></li>
        ...
        <!--  <li> <a href="<?=base_url?>/buy-health-insurance-online ">Health Insurance Quote </a></li>-->
         ...
         <ul class="plan-list">
          ...
          <li><a href=" https://www.kotaklife.com/insurance-plans/savings-and-investments-plans  "> Savings & Investment Plans</a></li>
          <ul class="mtb-0">
      ...
      <div class="articles w-footer-30">
        ...
        <ul class="plan-list">
          ...
          <li> <a href=""> Online Unit-Linked Insurance Plan(ULIP)</a></li>
          ...
          <li> <a href="<?=base_url?>/online-plans/retirement-pension-plans"> Online Retirement Pension Plan </a></li>
          <ul class="mtb-0">
            <li> <a href="<?=base_url?>/online-plans/retirement-pension-plans/kotak-lifetime-income-plan"> Kotak Lifetime Income Plan </a></li>
          </ul>
         <!-- <li> <a href="<?=base_url?>/insurance-plans/health-plans"> Online Health Insurance Plan </a></li>
          <ul class="mtb-0">
            <li> <a href="<?=base_url?>/insurance-plans/health-plans/kotak-health-shield"> Kotak Health Shield Plan </a></li>
          </ul>-->

          <li> <a href=" https://www.kotaklife.com/insurance-plans/savings-and-investments-plans"> Online Savings & Investment Plan</a></li>
        </ul>
  ...
  <div class="polular-searches">
      ...
      <div class="popular-search-anc">
        <ul>
          ...
          <li><a href="<?=base_url?>/online-plans/retirement-pension-plans">Retirement Plan</a></li>
  ...
  <div class="midWrapper">
    ...
    <ul class="btmlinks">
      ...
      <!--<li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'IRDAI'});" href="https://www.policyholder.gov.in/" rel="nofollow" target="_blank">IRDAI</a></li>www.policyholder.gov.in/-->
  ...
  <!-- <li>
           <div id="start"  class=""  style="color:#fff;"><img class="play--imag" src="<?= base_url() ?>assets/images/texttospeach/play1.png"></div>
		   <li>
          <div id="cancel" class="pauseee--text"  style="color:#fff;display:none;"><img class="play--imag" src="<?= base_url() ?>assets/images/texttospeach/pause1.png"></div>
    </li> -->
  ...
  <!-- <div style="width: 50%; padding-top: 100px;">
    ...
    <div id="cancel" class="pauseee--text"  style="color:#fff;display:none;"><img class="play--imag" src="<?= base_url() ?>assets/images/texttospeach/pause1.png"></div>
    <div id="start"  class=""  style="color:#fff;"><img class="play--imag" src="<?= base_url() ?>assets/images/texttospeach/play1.png"></div>
    <div id="start"  class=""  style="color:red;"> <i class="fa fa-play-circle" aria-hidden="true"></i></div>
    </div> 
  </div> -->
  <?php
...
<script charset="UTF-8" src="https://toolassets.haptikapi.com/platform/javascript-xdk/production/loader.js"></script>
<script>
...
<?php 
 ...
 <script>
  ...
  $(".rhsBoxDetailWrap").toggleClass("activate");
  $(".buyOnline").toggleClass("selected");
  $(".overlay").show();  
});
</script>
<script>
...
<script src="./assets/js/speechtotext/textToSpeech.js"></script>
</body>
</html>
