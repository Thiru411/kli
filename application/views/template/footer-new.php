        ...
        <div class="midWrapper">
            <div class="plans roww">
                ...
                <div class="incurance w-footer-20">
                    <h6 class="footer-title">Life Insurance Plans</h6>
                    <ul class="plan-list">
                ...
                <div class="incurance w-footer-20">
                    <h6 class="footer-title">CALCULATORS</h6>
                ...
                <div class="incurance w-footer-20">
                    ...
                    <ul class="plan-list fnt-14">
                        <li> <a  href="https://www.kotaklife.com/buy-online-term-insurance/?utm_source=organic&utm_medium=website&utm_campaign=footer" target="_blank">Buy Term Insurance Online</a> </li>
                        <li> <a  href="https://www.kotaklife.com/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=website&utm_campaign=footer" target="_blank">Invest in ULIP Plan</a></li>
                ...
                <div class="incurance w-footer-20 n-mar">
                    <ul class="plan-list">
                        <li> <a href="<?=base_url()?>insurance-plans/retirement-plans">Retirement Plans</a>
							<ul class="footer-sub-menu sub-bot-2">
                                <li>
                                    <a href="online-plans/retirement-pension-plans/kotak-lifetime-income-plan">Kotak Lifetime Income Plan</a>
                                </li>
    ...
    <div class="footer-menu footer-menu-list f-sec">
        <div class="midWrapper">
            <div class="plans roww">
                ...
                <div class="incurance w-footer-20">
                    <h6 class="footer-title">Insurance Guide</h6>
                    <ul class="plan-list">
                ...
                <div class="d-flex dsocial">
                    <div class="social-space">
                        ...
                        <ul class="d-flex social-data">
                            <li><a href="https://www.facebook.com/kotaklife/?utm_source=website&utm_medium=FB_icon&utm_campaign=HR_session" class="facebbok" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="https://twitter.com/Kotak_Life?utm_source=website&utm_medium=TW_icon&utm_campaign=HR_session" class="twitter" target="_blank"><i class="fa-brands fa-x-twitter"></i>
                            <svg class="new-twitter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" version="1.1">
 <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
</svg>
                           </a></li>
                            <li><a href="https://www.linkedin.com/company/kotak_life/" class="linkedin" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.youtube.com/kotaklifeinsuranceofficial" class="youtube" target="_blank"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.instagram.com/kotak.lifeinsurance/?utm_source=website&utm_medium=IG_icon&utm_campaign=HR_session" class="instagram" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        </ul>
                    ...
                    <p>Download the HappyYou by Kotak Mobile App
                        ...
                        <a class="apple-store" href="https://apps.apple.com/in/app/happyyou/id6448199779?utm_source=KLI&utm_medium=KLI+website&utm_campaign=HY+appstore&utm_id=Website-+HY+App+store" target='_blanck'><!--<img src="<?php echo base_url() ?>assets/images/ios-app.svg">--></a>
                        <a class="google-store" href="https://play.google.com/store/apps/details?id=com.wyh.happyyou&referrer=utm_source%3DKLI%26utm_medium%3DKLI%2BWebsite%26utm_campaign%3DHY%2BPlaystore" target='_blanck'></a>
                        </div>
                        <div class="g20">
...
<p> IRDAI or its officials do not involve in activities like selling insurance policies, announcing bonus or investment of premiums. Public receiving such phone calls are requested to lodge a police complaint.
    ...
    <div class="new-desclaimer">
        <div class="midWrapper">
            <ul class="btmlinks">
                ...
                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'IRDAI Customer Education'});" href="https://www.policyholder.gov.in/"  target="_blank">IRDAI Customer Education</a></li>
                <!--www.policyholder.gov.in/-->

                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'IRDAI'});" href="https://www.irdai.gov.in/"  target="_blank">IRDAI</a></li>
               

                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'Insurance Ombudsman'});" href="https://www.cioins.co.in/Ombudsman"  target="_blank">Insurance Ombudsman</a></li>
                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'Kotak Mahindra Bank'});" href="https://www.kotak.com/" target="_blank">Kotak Mahindra Bank</a></li>
                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'Life Insurance Council'});" href="https://www.lifeinscouncil.org/code/Default.aspx"  target="_blank">Life Insurance Council</a></li>
                ...
                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'Bima Bharosa'});" href="https://bimabharosa.irdai.gov.in" target="_blank">Bima Bharosa</a></li>
                <li><a onClick="dataLayer.push({'event':'event footer 2', 'category':'footer', 'action':'footer b','label':'IRDAIs Call Centre Feedback Survey'});" href="https://www.mygov.in/mygov-survey/irdais-call-centre-feedback-survey/" target="_blank">IRDAI's Call Centre Feedback Survey</a></li>
    ...
    <div style="">
        <div style="max-width: 7000px; margin: 0 auto; padding: 0 40px; text-align: left;">
            ...
            <img src="assets/images/chatexit.gif" onClick="openChat()" class="custom-icon mobilechat w-130">
        </div>
    </div>
       ...
       <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.10/jquery.mousewheel.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jScrollPane/2.0.20/script/jquery.jscrollpane.min.js"></script>-->
        <script src="<?=base_url()?>assets/js/jpreloader.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js"></script>
       <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/hammer.js/2.0.8/hammer.min.js"></script>-->
        <script src="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
        <script src="<?=base_url()?>assets/js/common.js"></script>
         <script src="<?=base_url()?>assets/js/common-dev.js"></script> 
