...
<div class="midWrapper">
	<div class="plans ">
		<div class="incurance">
			<ul class="plan-list">
				...
				<li><a href="">Kotak e-Term Plan</a></li>
				...
				<li><a href=base_url."/insurance-plans/savings-and-investments-plans/kotak-single-invest-plus">Kotak Single Invest Plus</a></li>
				...
				<li><a href=base_url."/insurance-plans/retirement-plans/kotak-lifetime-income-plan">Kotak Lifetime Plan</a></li>
				...
				<li><a href=base_url."/insurance-plans">Life Insurance</a></li>
			...
			<!--	<li><a href=base_url."/insurance-plans/health-plans/kotak-health-shield">Health Shield</a></li>-->
			...
			<ul class="plan-list">
				...
				<li><a href=base_url."/online-plans/online-term-insurance-plans/kotak-e-term-plan-online">Kotak e-Term Plan</a></li>
				
				
				<li><a href=base_url."/einsurance/OnlineTerm.aspx?PID=EON">Term Insurance Caluclator</a></li>
		...
		<div class="articles">
			<ul class="plan-list">
				...
				<li><a href=base_url."/insurance-guide/about-life-insurance/Importance-of-claim-settlement-ratio-before-buying-life-insurance">Claim Settlement Ratio</a></li>
			...
			<ul class="plan-list">
				...
				<li><a href=base_url."/group-plans/group-superannuation/kotak-secure-return-superannuation-plan">Kotak Secure Return Superannuation Plan</a></li>
  ...
  <div class="midWrapper">
	...
	<ul class="shareUL">	
		...
		<li><a onClick="dataLayer.push({'event':'event footer social', 'category':'footer', 'action':'social media icons','label':'Instagram'});" href="https://www.instagram.com/kotak.lifeinsurance/" target="_blank" class="instagram">Instagram</a></li>
    </ul>
	-->
...
<!-- codebele code for disclaimer added -->
<button id="myBtn" class="disclaimer_btn">Disclaimer</button>
<div id="myModal" class="disclaimer_modal">
<!-- Modal content -->
  <div class="disclaimermodal-content">
    <span class="disclaimer_close">&times;</span>
   
    <div class="btmDesc">
     <p><b>BEWARE OF SPURIOUS / FRAUD PHONE CALLS</b></p><br>	
      <p>     
...
<!-- <div class="w3-modal-content modal-sm">
          <div class="w3-container">
            ...
            <div class="center-text">
                <img class="pic" src="<?php echo base_url() ?>assets/images/kaya.png">
                <h2 class="name">Kaya is online  <span class="green-dot"></span></h2>
...
--> 
		...
		<div class="floating_bttns">
			<div class="floating_opt">
  				<ul>
  				
  				    <li class="term_insurance">Term Insurance</li>
  				    <li class="terms">Terms</li>
  				    <!-- <li class="need">Need for Term Insurance</li> -->
  				    <li class="who_buy">Who should buy</li>
  				    <li class="featured">Featured insurance plans</li>
  				    <li class="types">Types of Term Insurance Plans</li>
  				    <!-- <li class="right_time">Right Time to Buy</li> -->
  				    <li class="payout">Payout Options</li>
  				    <li class="factors">Affecting Factors</li>
  				    <li class="how_to_choose">How to Choose</li>
  				    <li class="steps">Steps to Buy</li>
  				    <li class="benefits">Benefits</li>
  				    <li class="faqs">Frequently asked quetions</li>
  				    <li class="product_info">Product information</li>
  				    
      				<!-- <li class="product_info">Product information</li>
      				<li class="hq_wrks">How it works</li>
      				<li class="uses">Uses</li>
      				<li class="benefits">Benefits</li>
      				<li class="featured_plans">Featured insurance plans</li>
    				<li class="who_buy">Who should buy</li>
    				<li class="hw_buy">How to Buy</li>
    				<li class="faqs">Frequently asked quetions</li>
    				<li class="related_arti">Related articles</li>
    				<li class="cus_speak">Customer speak</li> -->
  				</ul>
  			</div>
  			<div class="red_btn">
  				<h1>Content</h1>
...
<script src=base_url."/assets/js/jquery-migrate-1.2.1.min.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/jpreloader.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/jquery.mousewheel.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/jquery.jscrollpane.min.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/owl.carousel.min.js" type="text/javascript" language="javascript"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/hammer.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/common.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/common-dev.js" type="text/javascript" language="javascript"></script>
<script src=base_url."/assets/js/need_base_cal.js" type="text/javascript" language="javascript"></script>

<!-- <script src="assets/js/jquery-1.11.2.min.js" type="text/javascript" language="javascript"></script> -->
<!-- <script src="assets/js/jquery.mousewheel.js" type="text/javascript" language="javascript"></script> -->
<!-- <script src="assets/js/hammer.js" type="text/javascript" language="javascript"></script> -->
<!-- <script src="assets/js/common.js" type="text/javascript" language="javascript"></script> -->

  <!--<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>-->
    <script src="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
    <script src=base_url."/assets/eterm/js/jquery.rateyo.min.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script src=base_url."/assets/eterm/js/main.js"></script>
...
<script type="text/javascript">
    ...
    $(".who_buy").click(function() {
        $('html, body').animate({
            scrollTop: $("#who_buy").offset().top
        }, 2000);
    });
    ...
    $(".factors").click(function() {
        $('html, body').animate({
            scrollTop: $("#factors").offset().top
        }, 2000);
    });
    
    $(".how_to_choose").click(function() {
        $('html, body').animate({
            scrollTop: $("#how_to_choose").offset().top
        }, 2000);
    });
    ...
    $(".term_insurance").click(function() {
        $('html, body').animate({
            scrollTop: $("#term_insurance").offset().top
        }, 2000);
    });
...
//     $('.floating_bttns').mouseover(function() {
//         $('.floating_opt').stop(true, true).show(400);
//     }).mouseout(function() {
//         $('.floating_opt').stop(true, true).hide(400);
//     });
</script>
<script type="text/javascript">
...
<a id="scroll-top" href="#header_sec">
<img src="<?=base_url()?>assets/images/scroll_top.png" alt="Scroll top" class="up-arrw " />
      </a>
<script>
  $("#scroll-top").click(function(){$("html").animate({scrollTop:0},"slow");});$(window).scroll(function(){if($(this).scrollTop()>500)
{$('.up-arrw').fadeIn();}
else
{$('.up-arrw').fadeOut();}})
</script>
...
var span = document.getElementsByClassName("disclaimer_close")[0];
...
<!-- ends codeble changes -->
<?php 
$actual_link1 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "https") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";  
