 ...
 <section class="best-invest">
        ...
        <?php $title=''; foreach($alsoReadArticlesInfo as $article) {
					...
					if($category == 'about-life-insurance'){
                        ...
                        $brochure_link = base_url().'assets/images/uploads/insurance-plans/Kotak_e-Term_Plan_Brochure.pdf';
                        $features = '<ul>
                        ...
                        $buy_plan_link = base_url().'buy-online-term-insurance/#/landing?utm_source=organic&utm_medium=website&utm_campaign=product_card&utm_content='.$blogTitles;
...
4 Annuity Modes</span></li>
                    ...
                    $sapimg_link='';
                     ...
                     if ($category == 'health-insurance') { 
                        ...
                        $know_more_link = base_url().'online-plans/online-term-insurance-plans/kotak-e-term-plan-insurance';
                        $buy_plan_link = base_url().'buy-online-term-insurance/?utm_source=organic&utm_medium=website&utm_campaign=product_card&utm_content='.$blogTitles;
                        $ref_no = 'Ref. No. KLI/22-23/E-BB/2435';
                    }
                              ...
                              <?php if ($CategoryName == "Savings & Tax ") { ?>
                                 ...
                                 <div class="dd-btn-flex blog-detail">
								  ...
								  <?php } else { ?>
																	...
																	<a rel="follow" href="<?=base_url?>/buy-online-term-insurance/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Calculate Term Insurance Premium</a>
...
<?php }else if ($articlesInfo->article_title=='Form 16, Form 16A, and Form 16B?'){?>
																...
																<!--<a rel="follow" href="<?=base_url?>"/buy-health-insurance-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Invest in Health Insurance</a>-->
												          ...
												          <a rel="follow" href="<?=base_url?>/buy-online-term-insurance/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Calculate Term Insurance Premium</a>
																...
																<a rel="follow" href="<?=base_url?>/buy-health-insurance-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" onclick="dataLayer.push({'event': 'event health insurance', 'category': 'new customers', 'action': 'health insurance', 'label': 'health insurance'});">Calculate Health Insurance Premium</a>
															...
															<?php }else if($articlesInfo->article_title=="Section 80C Deductions as per Income Tax Act, 1961 " || $articlesInfo->article_title=="Interest Imposed Under Sections 234A, 234B and 234C" || $articlesInfo->article_title=="Income Tax Deductions & Exemptions under Sections 80C, 80D & 80DDB for FY  2021-22 & 2022-23" || $articlesInfo->article_title=='Section 80D - Medical and Health Insurance Tax Benefits Under Section 80D' || $articlesInfo->article_title=='What are Deferred Savings Plans? '){?>
															 <a rel="follow" href="<?=base_url?>/insurance-plans/savings-and-investments-plans/kotak-assured-savings-plan/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Buy Kotak Assured Savings Plan</a>
                                                             <a rel="follow" href="<?=base_url?>/online-plans/savings-plan/kotak-guaranteed-savings-plan-online/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" class="redBtn">Buy Kotak Guaranteed Savings Plan</a>
															
															<?php }else if($articlesInfo->article_title=="8 Things to Help You Select a Savings Investment plan"){ ?>
															<a rel="follow" href="<?=base_url?>/buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Buy Kotak Assured Savings Plan Online</a>
                                                             <a rel="follow" href="<?=base_url?>/buy-kotak-guaranteed-savings-plan-online/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" class="redBtn">Buy Kotak Guaranteed Savings Plan Online</a>
															...
															<a rel="follow" href="<?=base_url?>/buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Invest in Assured Savings Plan</a>
                                                           <a rel="follow" href="<?=base_url?>/buy-kotak-guaranteed-savings-plan-online/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" class="redBtn"> Invest in Guaranteed Savings Plan</a>
				                                          <?php }else{?>
															<a rel="follow" href="<?=base_url?>/buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" target="_blank" class="redBtn ksap-btn online-dnone">Invest in Kotak Assured Savings Plan</a>
															<a rel="follow" href="<?=base_url?>/buy-kotak-guaranteed-savings-plan-online/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $articlesInfo->article_title;?>" class="redBtn"> Invest in Kotak Guaranteed Savings Plan</a>
															<?php }?>
	  </div>
						 ...
						 <a rel="follow" href='<?=base_url?>/online-plans/savings-plan/#/landing?utm_source=gsp_organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $article_title?>' target="_blank" onclick="dataLayer.push({'event': 'event saving and tax', 'category': 'new customers', 'action': 'saving and tax', 'label': 'saving and tax'});">Invest in Savings Plan</a>
							...
							<?php }else{?>
                                  <a rel="follow" href="<?=base_url?>/buy-online-term-insurance/?utm_source=organic&utm_medium=website&utm_campaign=blog_cta&utm_content=<?php echo $article_title?>" target="_blank" onclick="dataLayer.push({'event': 'event protection', 'category': 'new customers', 'action': 'protection', 'label': 'protection'});">Know About Term Plan</a>
								   <?php }?>
