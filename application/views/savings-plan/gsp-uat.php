...
<div>
    <section class="bannerr top-171 mtt-102 ulip-cat-mt saving-banner">
        <div class="midWrapper">
            <div class="topSection-grid">
                <div>
                    <h1 class="savingsTitle">Savings Plans</h1>
                    ...
                    <div class="savingsImg"><img class="lzy_img" width="100%" height="267px" src="assets/images/saving-plans/savingsPlan.svg" alt="Savings Plan"></div>
                </div>
                <div class="productCard-flex">
                    <div class="productCard1">
                        ...
                        <p class="productCard1-subdesc">after 1 year Get<br><span class="productCard1-value">₹1,11,996</span>/year for 25 years</p>
                    ...
                    <div class="productCard2">
                        ...
                        <p class="productCard2-desc">Pay<span class="productCard1-amt">₹1,00,000</span>/year for 10 years</p>
                        <p class="productCard2-subdesc">Get<br><span class="productCard1-value">₹29.01L</span>after 20th year</p>
                        <p class="productCard2-subdesc">Death benefit/Life cover:<span class="productCard1-value">₹29.01 Lakhs<sup>#</sup></span></p>
                    ...
                    <div class="authorDetails">
                        <div class="blogsTooltipSavings">
                            <div class="authorName">
                                <div class="authorImg sa-author1"><!--img src="assets/images/saving-plans/Amit.png" width="auto" height="auto" alt="Amit Raje"--></div>
                                <div class="nameTitle">
                        ...
                        <div class="blogsTooltipSavings">
                            <div class="authorName">
                                <div class="authorImg sa-author2">
                                <!--img width="auto" height="auto" src="assets/images/saving-plans/Prasad.png" alt="Prasad Pimple"--></div>
                                <div class="nameTitle">
    ...
    <section id="tableofContent">
        <div class="midWrapper"><span class="tocText">Table of Contents</span>
            <div class="contenttable show-more-height">
                <div><a href="<?php echo $actual_link ?>#whatIsSavingsPlan" class="tocContent"><span>What are Savings Plan?</span></a><a href="<?php echo $actual_link ?>#savingsPlan" class="tocContent"><span>Best Savings Plans from Kotak Life</span></a><a href="<?php echo $actual_link ?>#whoBuy" class="tocContent"><span>Who Should Buy a Savings Insurance Plan?</span></a><a href="<?php echo $actual_link ?>#chooseInvest" class="tocContent"><span>How to Choose the Right Investment Plan Options?</span></a><a href="<?php echo $actual_link ?>#whyChoose" class="tocContent"><span>Why Choose Kotak Life for Savings Plan in India?</span></a><a href="<?php echo $actual_link ?>#considerInvest" class="tocContent"><span>Considerations to Make Before Investing in a Savings Plan</span></a><a href="<?php echo $actual_link ?>#longInvest" class="tocContent"><span>How Long Should You Invest in a Savings Plan?</span></a><a href="<?php echo $actual_link ?>#buySavings" class="tocContent"><span>Steps to Buy Savings Plan Online</span></a><a href="<?php echo $actual_link ?>#document-required" class="tocContent"><span>Documents Required to Buy Savings Plan Online</span></a><a href="<?php echo $actual_link ?>#factors" class="tocContent"><span>Factors Impacting Savings Plan Premium</span></a></div>
        ...
        <div class="midWrapper">
            <div class="whatIsSavingsPlan-grid">
                ...
                <div class="whatIsSavingsPlan-img">
                    <div class="savings-videos"><iframe width="100%" height="300" src="https://www.youtube.com/embed/5SVUD3KS-1I?rel=0?version=3&autoplay=1&controls=0&&showinfo=0&loop=1&modestbranding=1&playsinline=1&rel=0" title="Things to know before investing in endowment plan | Kotak Life" controls="0"></iframe>
                        <style>
                            .ytp-copylink-button {
            ...
            <div class="midWrapper">
                <div class="kotakBanner">
                    <div class="savingcard-slider">
                        <div><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-guaranteed-fortune-builder?utm_source=kgfb_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=imgbanner" target="_blank">
                        <img class="lzy_img" src="assets/images/saving-plans/KASP-Banner.png" width="auto" height="auto" alt="Kotak Assured Savings Plan"></a></div>
                        <div><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=imgbanner" target="_blank">
                        <img src="assets/images/saving-plans/Kotak-e-Term.png" class="lzy_img" width="auto" height="auto" alt="Kotak e-Term Plan"></a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="keyFeatureSavings-list">
                ...
                <div class="keyFeatureSavings-flx">
                    ...
                    <div class="pl10">
                        ...
                        <p class="keyFeatureSavings-subdesc">You can select a policy term period that best fits your requirements. You might choose the short-term savings plan if you anticipate you will need your money soon. Also, you can extend your insurance for a higher number of years if you want to save for the long term.</p>
                    </div>
                </div>
                <div class="keyFeatureSavings-flx">
                    <div class="arrowBg">
    ...
    <section id="savingsPlan">
        <div class="fullBg pb10">
            <div class="midWrapper">
                <div class="savingsPlan-sec">
                    <h2 class="savingsPlan-title">Best Savings Plans from Kotak Life</h2>
                    <p class="savingsPlan-desc">Kotak Life offers some of the best savings plans that give guaranteed returns. Check out Kotak Life savings plans:</p>
                ...
                <div class="roww bestsavgsp save-offline">
                    ...
                    <div class="coll-md-9 saving-acc">
                        <div class="kotaksavcard accelcard op1 accelblock">
                            ...
                            <div class=""><a href="https://www.kotaklife.com/savings-plan/kotak-assured-income-accelerator" class="gspview">View Kotak Assured Income Accelerator Plan</a></div>
                        </div>
                                ...
                                <div class="kotaksavcard accelcard accelcardacc">
                                    <div class="d-flex">
                                        <div class="roww mg-30">
                                            <div class="coll-md-6">
                                                <ul>
                                                    <li>Vested bonuses<sup>*</sup>along with maturity benefits</li>
                                                    <li>Discounts on premium with high sum assured</li>
                                                    <li>Choice of policy term options</li>
                                                </ul>
                                            </div>
        ...
        <div class="blueBg">
            <div class="midWrapper">
                <div class="blueBg-grid">
                    ...
                    <div class="blueBg-img"><img class="lzy_img" src="assets/images/saving-plans/Kotak-fortune-Builder-Icon.svg" width="100%" height="100%" alt="Kotak Fortune Builder"></div>
                </div>
            </div>
        </div>
    </section>
    <section id="benefitsSavings">
        <div class="midWrapper">
            <h2 class="benefitsSavings-title">What are the Benefits of Savings Plans?</h2>
            <p class="benefitSavings-desc">Savings plans serve as a foundation for building a strong financial portfolio. It enables individuals to achieve their short-term and long-term goals while safeguarding against unexpected expenses. Saving for down payment on a house, funding higher education, or ensuring a comfortable retirement, these savings plans offer a structured approach to promote financial discipline and encourage a habit of regular savings. The infographic alongside displays the benefits of savings plans.</p><br>
            ...
            <div class="benefitsOfSavings mobNone"><img  class="lzy_img" src="assets/images/saving-plans/benefitsOfSaving.png" width="100%" height=100% alt="Benefits of Savings Plan"></div>
            ...
            <div class="savingsPlan-cta2" style="text-align:center"><a href="https://www.kotaklife.com/buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=bluebanner2">Invest Now</a></div>
        </div>
    </section>
    <section id="whoBuy">
        <div class="greyBg">
            <div class="midWrapper">
                ...
                <p class="whoBuy-desc">Savings plans offer a combination of savings and insurance benefits. You must check if the savings insurance plan you are planning to buy aligns with your requirements. Here is how a savings insurance plan can help you. Read more-<a href="https://www.kotaklife.com/savings-plan/who-should-invest-in-savings-plan" class="inLine-links">Who should invest in a savings plan?</a></p>
                <div class="whoBuy-cards">
                    <div class="whoBuy-card">
                        <div class="sp-saving sps1"></div>
                        <h3 class="whoBuy-subTitle">Young Entrepreneurs</h3>
                        <p class="whoBuy-subDesc">Beginning early give investors, a chance to take greater risks and increase their chances of earning better returns. They have more time to recover from poor choices without having an impact on their long-term financial objectives. Young entrepreneurs should buy savings plan in their early days so they can get a solid second income during their entrepreneurship stint.</p>
                    </div>
                    <div class="whoBuy-card">
        ...
        <div class="blueBg">
            <div class="midWrapper">
                <div class="blueBg-gridR">
                    <div class="blueBg-imgR"><img class="lzy_img" src="assets/images/saving-plans/Kotak-fortune-Builder-Icon2.svg" width="100%" height="100%" alt="Kotak Fortune Builder"></div>
                    <div class="textLeft">
            ...
            <div class="pb10 pbm5">
                ...
                <div class="chooseInvest-grid">
                    ...
                    <div>
                        ...
                        <p class="chooseInvest-subdesc">The time horizon for your savings goal plays a vital role in choosing the right savings plan. Short-term goals, such as saving for a vacation or buying a car in a few years, may benefit from more liquid and low-risk options like a regular savings account. Conversely, long-term goals like retirement planning may require investment-based savings plans to offer the potential for higher returns over an extended period.</p>
                    </div>
                </div>
                <div class="chooseInvest-grid">
                    <div class="chooseInvest-numeric">
                ...
                <div class="chooseInvest-grid">
                    ...
                    <div>
                        ...
                        <p class="chooseInvest-subdesc">Take the time to research and compare different savings plans offered by financial institutions. Look for plans that offer competitive interest rates, low fees, and favorable terms. Consider consulting with a financial advisor who can provide expert guidance tailored to your specific needs and goals. You should consider an insurance company that has a high solvency ratio. Kotak Life Insurance has a solvency ratio of 2.64%.</p>
                    </div>
                </div>
                <div class="chooseInvest-grid">
                    <div class="chooseInvest-numeric">
        ...
        <div class="blueBgS">
            <div class="midWrapper">
                <div class="blueBg-grid">
                    ...
                    <div class="blueBg-imgS"><img class="lzy_img" src="assets/images/saving-plans/Kotak-fortune-Builder-Icon5.svg" width="100%" height="100%" alt="Kotak Fortune Builder"></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="whenBuy-grid">
                    <div>
                        <div class="whenBuy-flx">
                            ...
                            <div class="pl10">
                                <h3 class="whenBuy-subtitle">Buying Savings Plan in Your 20s:</h3>
                    ...
                    <div class="whenBuy-img mobNone"><img class="lzy_img" src="assets/images/saving-plans/Kotak-life-Savings-Plan.svg" width="100%" height="100%" alt="Kotak life Savings Plan"></div>
                    <div class="whenBuy-img deskNone mobblock"><img class="lzy_img" src="assets/images/saving-plans/Kotak-life-Savings-PlanMob.svg" alt="Kotak life Savings Plan"></div>
                </div>
            </div>
        </div>
    </section>
    <section id="fullWBannerR">
        <div class="blueBgN">
            <div class="midWrapper">
                <div class="blueBg-gridR">
                    <div class="blueBg-imgN"><img class="lzy_img" src="assets/images/saving-plans/Kotak-fortune-Builder-Icon3.svg" width="100%" height="100%" alt="Kotak Fortune Builder"></div>
                    <div class="textLeft">
    ...
    <section id="whyChoose">
        <div class="midWrapper">
            ...
            <div class="whyChoose-flx">
                ...
                <div>
                    <h3 class="whyChoose-subTitle">Customized Savings Plans</h3>
            ...
            <div class="whyChoose-flxB">
                <p>Kotak Guaranteed Fortune Builder- investment for<br>guaranteed income.</p><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-guaranteed-fortune-builder?utm_source=kgfb_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=bluebanner3">Start investing</a>
            </div>
        ...
        <div class="blueBg">
            <div class="midWrapper">
                <div class="blueBg-grid4">
                    <div class="blueBg-imgR"><img src="assets/images/saving-plans/Kotak-fortune-Builder-Icon4.svg" width="100%" height="100%" alt="Kotak Guaranteed Savings Plan" class="icon4 lzy_img"></div>
                    <div class="textLeft">
    ...
    <section id="buySavings">
        <div>
            <div class="midWrapper">
                ...
                <div class="buySavings-img mobNone"><img class="lzy_img" src="assets/images/saving-plans/stepToBuy.jpg" width="auto" height="auto" alt="Kotak Savings Plan"></div>
                ...
                <div class="coll-md-6">
                    <div class="how-slick">
                        <div class="" style="" aria-hidden="true" tabindex="0">
                            <div class="roww">
                                <div class="coll-md-1 text-center"></div>
            ...
            <div class="midWrapper">
                <div class="blueBg-gridL">
                    <div class="textLeft">
                        ...
                        <div class="savingsPlan-cta2" style="text-align:left"><a href="https://www.kotaklife.com/life-insurance-plans/#/buy-kotak-assured-savings-plan-online/#/landing?utm_source=kasp_organic&utm_medium=website&utm_campaign=l2category_page&utm_content=brightfuture">Click to Buy</a></div>
                    </div>
                    <div class="blueBg-imgL"><img class="lzy_img" src="assets/images/saving-plans/Kotak-fortune-Builder-Icon6.svg" width="100%" height="100%" alt="Kotak Fortune Builder"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="what-policy-period how-buy-cat mt-30 save-faq" id="saving-plans-faqs">
        <div class="midWrapper">
            ...
            <div class="accordion-div accordion-btns accordion-btns-gsp mt-mob-15">
                <div class="bor">
                    <div class="accordion active" role="heading" aria-level="3"><span>1.</span>
                ...
                <div class="bor">
                    ...
                    <div class="panel tab-detail mb-0 tab-align">
                        <div class="">
                            <p>A<a href="savings-plan/kotak-guaranteed-savings-plan-online">guaranteed savings plan</a>offers the assurance of higher returns. The sum assured is declared upfront. Thus, such plans offer a fail-safe lump sum at the end of the policy tenure.</p>
                            <ul class="gspnewlis">
                                <li>
        ...
        <div class="midWrapper"><button name="disclaimers" type="button" class="collapsible terms-txt whitespace-initial">Disclaimers-</button>
            <div class="content-col mb-0 tab-align li-disc terms-para disclamier-pera pt-0">
                <div class="mb-0 save-disc">
                    ...
                    <p><b>Kotak Guaranteed Fortune Builder,</b>UIN: 107N128V04 Form No: N128. An Individual, Non-Linked, Non- Participating, Savings, Life Insurance Plan. This is a saving and protection oriented plan. For substandard lives, extra premium may be charged based on Kotak Life Insurance’s underwriting policy. This product is available for sale through online mode. For more details on risk factors, terms and conditions, please read sales brochure carefully before concluding a sale. For more details on riders please read the Rider Brochure.</p>
                    ...
                    <p><b>Kotak SmartLife Plan</b>UIN: 107N102V03, Form No: N102. This is a Savings-cum-Protection oriented Participating Endowment plan. For more details on risk factors, terms and conditions, please read sales brochure carefully before concluding a sale.</p>
                    <p>Kotak Premier Income Plan UIN: 107N099V02, Form No: N099. This is a participating anticipated endowment plan. For more details on risk factors, terms and conditions, please read sales brochure carefully before concluding a sale.</p>
                ...
                <div class="sec41">
                    ...
                    <p class="mtb-16" style="margin-bottom:16px!important">Fraud and Misstatement would be dealt with in accordance with provisions of Section 45 of the Insurance Act, 1938 as amended from time to time. Please visit our website for more details:</p><a class="inset-link panc" href="https://www.kotaklife.com/assets/images/uploads/why_kotak/section-38-39-45-of-insurance-act-
1938.pdf">https://www.kotaklife.com/assets/images/uploads/why_kotak/section-38-39-45-of-insurance-act- 1938.pdf</a>
                </div>
                <div class="sec41">
...
<script>
    ...
    setTimeout(() => {
        $(".bor:first-child .accordion").addClass('active');
