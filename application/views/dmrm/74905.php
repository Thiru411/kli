            ...
            <div id="lifeAdvisorData">
                <div class="searchAdvisorsResult">
                    <div class="advisorsWrap">
                        <img src="<?php echo base_url(); ?>assets/images/dmrm/74905.jpg" alt="Performance of Kotak Aggressive Growth Fund" title="Performance of Kotak Aggressive Growth Fund" class="advisorsImg prof-img">
                        <span class="advisorsImg verified-txt">Verified Agent</span>
                        <ul class="advisorsList">
                            <li>Name: <span>Mrs. Susmita Basu Thakur</span> </li>
