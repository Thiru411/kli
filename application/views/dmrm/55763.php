            ...
            <div id="lifeAdvisorData">
                <div class="searchAdvisorsResult">
                    <div class="advisorsWrap">
                        <img src="<?php echo base_url(); ?>assets/images/dmrm/55763.jpg" alt="Performance of Frontline Equity Fund" title="Performance of Frontline Equity Fund" class="advisorsImg prof-img">
                        <span class="advisorsImg verified-txt">Verified Agent</span>
                        <ul class="advisorsList">
                            <li>Name: <span>Mr. Rushi Nitinkumar Shah</span> </li>
                            <li>Location: <span>Baroda</span> </li>
                            <li>Working Since: <span>2016</span> </li>
                         </ul>
                    </div>
                </div>
            </div>
