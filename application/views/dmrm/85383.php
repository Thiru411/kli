            ...
            <div id="lifeAdvisorData">
                <div class="searchAdvisorsResult">
                    <div class="advisorsWrap">
                        <img src="<?php echo base_url(); ?>assets/images/dmrm/85383.jpg" alt="Performance of Frontline Equity Fund" title="Performance of Frontline Equity Fund" class="advisorsImg prof-img">
                        <span class="advisorsImg verified-txt">Verified Agent</span>
                        <ul class="advisorsList">
                            <li>Name: <span>Mr. Abhishek Parimal Jaykar</span> </li>
