            ...
            <div id="lifeAdvisorData">
                <div class="searchAdvisorsResult">
                    <div class="advisorsWrap">
                        <img src="<?php echo base_url(); ?>assets/images/dmrm/63184.jpg" alt="Performance of Kotak Opportunities fund in Equity" title="Performance of Kotak Opportunities fund in Equity" class="advisorsImg prof-img">
                        <span class="advisorsImg verified-txt">Verified Agent</span>
                        <ul class="advisorsList">
                            <li>Name: <span>Ms. S Nima</span> </li>
                            <li>Location: <span>Chennai</span> </li>
                            <li>Working Since: <span>2017</span> </li>
                         </ul>
                    </div>
                </div>
            </div>
