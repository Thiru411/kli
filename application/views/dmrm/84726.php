            ...
            <div id="lifeAdvisorData">
                <div class="searchAdvisorsResult">
                    <div class="advisorsWrap">
                        <img src="<?php echo base_url(); ?>assets/images/dmrm/84726.jpg" title="Performance of Kotak Dynamic Growth Fund" alt="Performance of Kotak Dynamic Growth Fund" class="advisorsImg prof-img">
                        <span class="advisorsImg verified-txt">Verified Agent</span>
                        <ul class="advisorsList">
                            <li>Name: <span>Mr. Ranodeep Sanyal</span> </li>
