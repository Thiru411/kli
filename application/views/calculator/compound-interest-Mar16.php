							...
							<div class="col-lg-5 m-no-padding"> 
								<div class="card card_middle p-0">
									<div class="card_body">
										...
										<canvas id="compound_interest_chart" height="220" class="compound_interest_chart"></canvas><a target="_blank" href="https://www.kotaklife.com/buy-e-invest-ulip-plan-online/#/landing?utm_source=ulip_organic&utm_medium=calculators&utm_campaign=compounding&utm_content=investnow" class="btn_primary m-0">Invest Now</a>
									</div>
								</div>
							</div>
						</div>
