...
<section>
  ...
  <article class="">
    <div class="midWrapper">
      <div class="headDesc">
        <h1>Career as Life Advisor</h1>
        <p>At Kotak, we nurture your entrepreneurial spirit to enable you to set up your own business. As a Life Advisor, you will experience a unique work culture which is informal, apolitical and transparent. It offers you freedom, ample learning opportunities and multiple avenues for lateral and vertical growth in your career.</p>
        ...
        <div class="videoList">
          <ul>
            ...
            <li rel="<?php echo $dt->youtube_video_id;?>">
              <div class="videoThum"> <a onClick="dataLayer.push({'event':'event life advisor video', 'category':'life advisor', 'action':'career as life advisor','label':'video played|<?php echo $dt->title;?>'});" href="javascript:;"  rel="https://www.youtube.com/embed/<?php echo $dt->youtube_video_id;?>" class="youTubeVideo" ><img src="http://img.youtube.com/vi/<?php echo $dt->youtube_video_id;?>/0.jpg"/></a></div>
              <div class="videoInfo">
