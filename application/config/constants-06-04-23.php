...
define('apiendpoint', 'https://localhost/kotaklife-corporate-webiste/kotaktv/Api/');
...
defined('ARTICLES_LIMIT')        			OR define('ARTICLES_LIMIT', 8);
defined('GLOSSARY_LIMIT')        			OR define('GLOSSARY_LIMIT', 4);
...
defined('ORG_IMG_URL')    		 		OR define('ORG_IMG_URL', 'http://localhost/kotaklife-corporate-webiste/assets/images/kotak-logo.png');
...
defined('ORG_WEBSITE_URL')       		OR define('ORG_WEBSITE_URL', 'http://localhost/kotaklife-corporate-webiste/');
