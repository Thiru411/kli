...
$(".moreless-button").click(function () {
    ...
    $("ul.fixedUL li a.buyOnline").click(function () {
        ...
        $(".overlay").removeClass("search_overlay"), $("html").removeClass("bodyScrollHide"), $("ul.ourCampaignUL li").removeClass("activate"), $(".rhsBoxDetailWrap, .rhsBoxDetailWrap_login").removeClass("activate"), $(".rhsBoxDetails .rhsboxWrap").fadeOut(), $(".overlay").fadeOut(), setTimeout(function () {
            $("ul.fixedUL li").removeClass("selected")
