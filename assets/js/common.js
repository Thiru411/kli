...
$(".moreless-button").click(function() {
    ...
    $("ul.fixedUL li a.buyOnline").click(function() {
        ...
        if ((w = $(window).width()) <= 1024 && $("html,body").animate({
            ...
            J = $(this).attr("class"), K = $("ul.fixedUL li .login").length > 0 ? 1 : "0", "login" != J && "getCall" != J && (a = parseInt(a - K), $(this).parent("li").addClass("selected").siblings("li").removeClass("selected"), $(".rhsBoxDetailWrap").addClass("activate"), $(".rhsBoxDetailWrap").addClass("activate"), $(".rhsBoxDetails .rhsboxWrap").eq(a).fadeIn().siblings(".rhsboxWrap").hide(), $(".overlay").fadeIn(), 0 == a && setTimeout(function() {
        ...
        $(".overlay").removeClass("search_overlay"), $("html").removeClass("bodyScrollHide"), $("ul.ourCampaignUL li").removeClass("activate"), $(".rhsBoxDetailWrap, .rhsBoxDetailWrap_login").removeClass("activate"),$("body").removeClass("buy_fixed"), $(".rhsBoxDetails .rhsboxWrap").fadeOut(), $(".overlay").fadeOut(), setTimeout(function() {
            $("ul.fixedUL li").removeClass("selected")
...
/*****gsp new v*****/
/*gsp scroll to section v*/

$(".gspwhat").click(function() {
    $('html,body').animate({
            scrollTop: $("#what_are_savings_plans").offset().top
        },
        'slow');
});
$(".gspbene").click(function() {
    $('html,body').animate({
            scrollTop: $("#benefits_of_savings_plans").offset().top
        },
        'slow');
});
$(".gspfeat").click(function() {
    $('html,body').animate({
            scrollTop: $("#features_of_savings_plans").offset().top
        },
        'slow');
});
$(".gspfeatbtn").click(function() {
    $('html,body').animate({
            scrollTop: $("#features-of-savings-plan").offset().top
        },
        'slow');
});
$(".gspsave").click(function() {
    $('html,body').animate({
            scrollTop: $("#kotak_savings_plan").offset().top
        },
        'slow');
});

$(".gspfaq").click(function() {
    $('html,body').animate({
            scrollTop: $("#saving_plans_faqs").offset().top
        },
        'slow');
});
$(".gsprel").click(function() {
    $('html,body').animate({
            scrollTop: $("#related_blogs").offset().top
        },
        'slow');
});
$(".gspread").click(function() {
    $('html,body').animate({
            scrollTop: $("#terms_conditions").offset().top
        },
        'slow');
});
/*gsp scroll to section ^*/

$(document).ready(function() {
    $(".opc1").click(function() {

        $(".op1").addClass("accelblock");
        $(".opc1").toggleClass("accelclr");

        $(".opc2").removeClass("accelclr");
        $(".opc3").removeClass("accelclr");
        $(".opc4").removeClass("accelclr");
        $(".opc5").removeClass("accelclr");
        $(".opc6").removeClass("accelclr");
        $(".opc7").removeClass("accelclr");
        $(".opc8").removeClass("accelclr");
        $(".opc9").removeClass("accelclr");
        $(".opc10").removeClass("accelclr");
        $(".opc11").removeClass("accelclr");
        $(".opc12").removeClass("accelclr");

        $(".op2").removeClass("accelblock");
        $(".op3").removeClass("accelblock");
        $(".op4").removeClass("accelblock");
        $(".op5").removeClass("accelblock");
        $(".op6").removeClass("accelblock");
        $(".op7").removeClass("accelblock");
        $(".op8").removeClass("accelblock");
        $(".op9").removeClass("accelblock");
        $(".op10").removeClass("accelblock");
        $(".op11").removeClass("accelblock");
        $(".op12").removeClass("accelblock");
    });
});

$(document).ready(function() {
    $(".opc2").click(function() {
        $(".op2").addClass("accelblock");
        $(".opc2").toggleClass("accelclr");

        $(".opc1").removeClass("accelclr");
        $(".opc3").removeClass("accelclr");
        $(".opc4").removeClass("accelclr");
        $(".opc5").removeClass("accelclr");
        $(".opc6").removeClass("accelclr");
...
$(document).ready(function() {
    $(".opc3").click(function() {
        $(".op3").addClass("accelblock");
        $(".opc3").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc4").click(function() {
        $(".op4").addClass("accelblock");
        $(".opc4").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc5").click(function() {
        $(".op5").addClass("accelblock");
        $(".opc5").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc6").click(function() {
        $(".op6").addClass("accelblock");
        $(".opc6").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc7").click(function() {
        $(".op7").addClass("accelblock");
        $(".opc7").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc8").click(function() {
        $(".op8").addClass("accelblock");
        $(".opc8").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc9").click(function() {
        $(".op9").addClass("accelblock");
        $(".opc9").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc10").click(function() {
        $(".op10").addClass("accelblock");
        $(".opc10").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc11").click(function() {
        $(".op11").addClass("accelblock");
        $(".opc11").toggleClass("accelclr");
...
$(document).ready(function() {
    $(".opc12").click(function() {
        $(".op12").addClass("accelblock");
        $(".opc12").toggleClass("accelclr");
...
/*slick counter gsp v*/
var $statusgsp = $('.pagingInfo-gsp');
var $slickElementgsp = $('.gspnewslickmobile');
$slickElementgsp.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide) {
    //currentSlide is undefined on init -- set it to 0 in this case (currentSlide is 0 based)
    var i = (currentSlide ? currentSlide : 0) + 1;
    $statusgsp.html('<span class="finished_count">' + (i + 0) + '</span>' + '<span class="total_count">' + '/' + slick.slideCount + '</span>');
});
/*slick counter gsp ^*/

/*slick counter gsp v*/
var $statusgspnew = $('.pagingInfo-gspnew');
var $slickElementgspnew = $('.gspnewslick');
$slickElementgspnew.on('init reInit afterChange', function(event, slick, currentSlide, nextSlide) {
    //currentSlide is undefined on init -- set it to 0 in this case (currentSlide is 0 based)
    var i = (currentSlide ? currentSlide : 0) + 1;
    $statusgspnew.html('<span class="finished_count">' + (i + 0) + '</span>' + '<span class="total_count">' + '/' + slick.slideCount + '</span>');
});
/*slick counter gsp ^*/
...
/*Glossary Banner for Mobile*/

$('.glssavingslider').slick({
    dots: false,
    arrows: false,
    infinite: false,
    speed: 300,
...
$('.share_toggle').on("click", function() {
    $('.glossary_share').stop().slideUp('fast');
    $(this).next('.glossary_share').stop().slideToggle('fast');
});
...
/*ulip new scroll to section v*/

$(".ulipwhat").click(function() {
    $('html,body').animate({
            scrollTop: $("#what_are_ulip").offset().top
        },
        'slow');
});
$(".ulipbene").click(function() {
    $('html,body').animate({
            scrollTop: $("#benefits_of_ulip").offset().top
        },
        'slow');
});
$(".ulipfeatbtn").click(function() {
    $('html,body').animate({
            scrollTop: $("#features_of_ulip").offset().top
        },
        'slow');
});
$(".ulipsave").click(function() {
    $('html,body').animate({
            scrollTop: $("#invest_in_ulip").offset().top
        },
        'slow');
});
$(".ulipbest").click(function() {
    $('html,body').animate({
            scrollTop: $("#best_ulip_plan").offset().top
        },
        'slow');
});
$(".uliptype").click(function() {
    $('html,body').animate({
            scrollTop: $("#different_ulip_types").offset().top
        },
        'slow');
});

$(".ulipfac").click(function() {
    $('html,body').animate({
            scrollTop: $("#various_factors").offset().top
        },
        'slow');
});
$(".ulipdoc").click(function() {
    $('html,body').animate({
            scrollTop: $("#documents_required").offset().top
        },
        'slow');
});
$(".ulipfaq").click(function() {
    $('html,body').animate({
            scrollTop: $("#ulip_faqs").offset().top
        },
        'slow');
});
$(".ulipread").click(function() {
    $('html,body').animate({
            scrollTop: $("#terms_conditions").offset().top
        },
        'slow');
});
/*ulip new scroll to section ^
/*gsp new slick ^*/
/***************ulip new ^*******************/
