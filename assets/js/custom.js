...
if(i==36){cardType="thankyoucard1";}
  ...
  if(i==39){cardType="thankyoucard4";}
	if(i==40){cardType="thankyoucard5";}
	if(i==41){cardType="thankyoucard6";}
	if(i==42){cardType="thankyoucard7";}
	if(i==43){cardType="thankyoucard8";}
  if(i==44){cardType="1";}
  if(i==45){$cardType="2";}
  if(i==46){cardType="3";}
  if(i==47){cardType="4";}
...
if(description!="" && category!="" && card_id!="" && customer_id!=""){
 ...
 $("#social_card_img_id").val(i);
  ...
  if(i==39){img="thankyoucard4.jpg";}
	if(i==40){img="thankyoucard5.jpg";}
	if(i==41){img="thankyoucard6.jpg";}
	if(i==42){img="thankyoucard7.jpg";}
	if(i==43){img="thankyoucard8.jpg";}
  if(i==44){img="1.jpg";}
  if(i==45){img="2.jpg";}
  if(i==46){img="3.jpg";}
  if(i==47){img="4.jpg";}
